...
{
    public class tblCom_sp_proveedoresDTO
    {
        ...
        public virtual List<tblCom_sp_proveedores_cta_depDTO> lstCuentas { get; set; }

        public virtual List<lstCuentasAEliminarProveedoresDTO> lstCuentasAeliminar { get; set; }

        public virtual List<tblCom_ArchivosAdjuntosProveedores> lstArchivos { get; set; }

        public virtual List<int> lstArchivosAeliminar { get; set; }

        public virtual List<tblCom_sp_proveedores_cta_depDTO> lstCuentasNuevas { get; set; }

        public bool esEdicionEnKontrol { get; set; }
