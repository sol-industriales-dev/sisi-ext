...
namespace Core.DTO.Maquinaria.BackLogs
{
    public class SeguimientoPptoDTO
    {
        ...
        public string vobo1 { get; set; }
        public string vobo2 { get; set; }
        ...
        public string nombreUserVobo1 { get; set; }
        public string nombreUserVobo2 { get; set; }
        public string nombreUserAutorizado { get; set; }
