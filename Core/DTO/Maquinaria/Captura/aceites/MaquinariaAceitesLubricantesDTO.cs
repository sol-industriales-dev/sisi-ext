...
namespace Core.DTO.Maquinaria.Captura.aceites
{
  public  class MaquinariaAceitesLubricantesDTO
    {
        ...
        public string CboMotor { get; set; }
        public int MotorId { get; set; }
        public decimal MotorVal { get; set; }
        public string CboTransmision { get; set; }
        public int TransmisionID { get; set; }
        public decimal TransmisionVal { get; set; }
        public string CboHidraulico { get; set; }
        public int HidraulicoID { get; set; }
        public decimal HidraulicoVal { get; set; }
        public string CboDiferencial { get; set; }
        public int DiferencialId { get; set; }
        public decimal DiferencialVal { get; set; }
        public string CboMandoFinal { get; set; }
        public string CboDireccion { get; set; }
        public string CboOtros { get; set; }
        ...
        public string CboGrasa { get; set; }
        public string Firma { get; set; }

        public string CboOtros1 { get; set; }
        public string CboOtros2 { get; set; }
        public string CboOtros3 { get; set; }
        public string CboOtros4 { get; set; }
