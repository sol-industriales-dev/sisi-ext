...
namespace Core.DTO.RecursosHumanos.Demandas
{
    public class HistoricoDTO
    {
        ...
        #region ADICIONAL
        public string estatusDemanda { get; set; }
        public string strSemaforo { get; set; }
        public string colorDiferencia { get; set; }
        public int cantDemandasSemaforoRojo { get; set; }
        public int cantDemandasSemaforoAmbar { get; set; }
        public int cantDemandasSemaforoVerde { get; set; }
        public int cantDemandasActivas { get; set; }
        public int cantDemandasCerradas { get; set; }
        #endregion
    }
}
