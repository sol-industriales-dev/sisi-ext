...
{
    public class tblC_sp_gastos_prov_activofijo
    {
        ...
        public Nullable<DateTime> fecha_autoriza_portal { get; set; }
        ...
        public Nullable<DateTime> fecha_autoriza_factura { get; set; }
