...
{
    public class tblRH_TAB_TabuladoresDet
    {
        #region SQL
        ...
        [ForeignKey("FK_Tabulador")]
        public virtual tblRH_TAB_Tabuladores tabulador { get; set; }

        [ForeignKey("FK_Categoria")]
        public virtual tblRH_TAB_CatCategorias categoria { get; set; }
    }
}
