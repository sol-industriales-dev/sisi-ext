...
{
    public class tblEN_ResultadoSubContratistas
    {
        public int id { get; set; }
        public int encuestaID { get; set; }
        public virtual tblEN_EncuestaSubContratista encuesta { get; set; }
        public int preguntaID { get; set; }
        public virtual tblEN_PreguntasSubContratistas pregunta { get; set; }
        ...
        public virtual tblEN_ResultadoSubContratistasDet EncuestaInfo { get; set; }
    }
}
