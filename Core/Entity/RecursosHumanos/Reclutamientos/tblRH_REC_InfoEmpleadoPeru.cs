...
{
    public class tblRH_REC_InfoEmpleadoPeru
    {
        ...
        public int essaludvida { get; set; }
        public string ruceps { get; set; }
        public int nopdt { get; set; }
        public int opcion01 { get; set; }
        public int opcion02 { get; set; }
