...
{
    public enum EstatusBackLogEnum
    {
        [DescriptionAttribute("Elaboración de Inspección (20%)")]
        ElaboracionInspeccion = 1,
        [DescriptionAttribute("Elaboración de Requisición (40%)")]
        ElaboracionRequisicion = 2,
