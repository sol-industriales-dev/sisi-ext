...
{
    public class _contextEnkontrolPrueba
    {
        ...
        //Función Where para checar si la consulta se hace a productivo o no.
        public static dynamic WhereCheckProductivo(string consulta)
        {
            var c = new Conexion();
            string jsonResult = "";

            //Bandera para cambiar del productivo a pruebas.
            var productivo = false;
