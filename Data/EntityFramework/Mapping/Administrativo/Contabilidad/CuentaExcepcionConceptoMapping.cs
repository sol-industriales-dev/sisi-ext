...
{
    class CuentaExcepcionConceptoMapping : EntityTypeConfiguration<tblEF_CuentaExcepcionConcepto>
    {
        public CuentaExcepcionConceptoMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblEF_CuentaExcepcionConcepto");
        }
    }
}
