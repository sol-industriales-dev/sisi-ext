...
namespace Data.EntityFramework.Mapping.Enkontrol.Poliza
{
    public class tblC_MovpolMapping : EntityTypeConfiguration<tblC_Movpol>
    {
        public tblC_MovpolMapping()
        {
            HasKey(x => x.id);
            ...
            HasRequired(x => x.tblPoliza).WithMany().HasForeignKey(y => y.polizaId);
            ToTable("tblC_Movpol");
        }
    }
}
