...
{
    public class sp_gastos_provMapping : EntityTypeConfiguration<tblC_sp_gastos_prov>
    {
        public sp_gastos_provMapping()
        {
            ...
            Property(x => x.numproPeru).HasColumnName("numproPeru");

            ToTable("tblC_sp_gastos_prov");
        }
    }
}
