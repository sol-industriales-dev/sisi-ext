...
{
    public class MatrizAccionesDisciplinariasMapping : EntityTypeConfiguration<tblSAC_MatrizAccionesDisciplinarias>
    {
        public MatrizAccionesDisciplinariasMapping()
        {
            HasKey(x => x.id);
            Property(x => x.id).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity).HasColumnName("id");
            ToTable("tblSAC_MatrizAccionesDisciplinarias");
        }
    }
}
