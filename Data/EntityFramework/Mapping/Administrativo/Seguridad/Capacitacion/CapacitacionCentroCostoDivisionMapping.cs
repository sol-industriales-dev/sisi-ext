...
{
    public class CapacitacionCentroCostoDivisionMapping : EntityTypeConfiguration<tblS_CapacitacionCentroCostoDivision>
    {
        public CapacitacionCentroCostoDivisionMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionCentroCostoDivision");
        }
    }
}
