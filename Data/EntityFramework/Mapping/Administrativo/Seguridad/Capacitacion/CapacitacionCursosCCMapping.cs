...
{
    public class CapacitacionCursosCCMapping : EntityTypeConfiguration<tblS_CapacitacionCursosCC>
    {
        public CapacitacionCursosCCMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionCursosCC");
        }
    }
}
