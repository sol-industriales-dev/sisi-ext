...
{
    public class CapacitacionCursosMandoMapping : EntityTypeConfiguration<tblS_CapacitacionCursosMando>
    {
        public CapacitacionCursosMandoMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionCursosMando");
        }
    }
}
