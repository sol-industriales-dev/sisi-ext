...
{
    public class CapacitacionDNCicloTrabajoAreasMapping : EntityTypeConfiguration<tblS_CapacitacionDNCicloTrabajoAreas>
    {
        public CapacitacionDNCicloTrabajoAreasMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionDNCicloTrabajoAreas");
        }
    }
}
