...
{
    public class CapacitacionDNCicloTrabajoRegistroAreasMapping : EntityTypeConfiguration<tblS_CapacitacionDNCicloTrabajoRegistroAreas>
    {
        public CapacitacionDNCicloTrabajoRegistroAreasMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionDNCicloTrabajoRegistroAreas");
        }
    }
}
