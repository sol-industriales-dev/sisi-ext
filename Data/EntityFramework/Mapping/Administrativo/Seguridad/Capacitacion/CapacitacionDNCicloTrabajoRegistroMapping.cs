...
{
    public class CapacitacionDNCicloTrabajoRegistroMapping : EntityTypeConfiguration<tblS_CapacitacionDNCicloTrabajoRegistro>
    {
        public CapacitacionDNCicloTrabajoRegistroMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionDNCicloTrabajoRegistro");
        }
    }
}
