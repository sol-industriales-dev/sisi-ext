...
{
    public class CapacitacionDNCicloTrabajoRegistroPropuestasMapping : EntityTypeConfiguration<tblS_CapacitacionDNCicloTrabajoRegistroPropuestas>
    {
        public CapacitacionDNCicloTrabajoRegistroPropuestasMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionDNCicloTrabajoRegistroPropuestas");
        }
    }
}
