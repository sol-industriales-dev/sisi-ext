...
{
    public class CapacitacionDNCicloTrabajoRegistroRevisionesMapping : EntityTypeConfiguration<tblS_CapacitacionDNCicloTrabajoRegistroRevisiones>
    {
        public CapacitacionDNCicloTrabajoRegistroRevisionesMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionDNCicloTrabajoRegistroRevisiones");
        }
    }
}
