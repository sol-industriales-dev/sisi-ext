...
{
    public class CapacitacionDNDeteccionPrimariaAreasMapping : EntityTypeConfiguration<tblS_CapacitacionDNDeteccionPrimariaAreas>
    {
        public CapacitacionDNDeteccionPrimariaAreasMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionDNDeteccionPrimariaAreas");
        }
    }
}
