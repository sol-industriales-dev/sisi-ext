...
{
    public class CapacitacionDNRecorridoAreasMapping : EntityTypeConfiguration<tblS_CapacitacionDNRecorridoAreas>
    {
        public CapacitacionDNRecorridoAreasMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionDNRecorridoAreas");
        }
    }
}
