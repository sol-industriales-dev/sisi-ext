...
{
    public class CapacitacionDNRecorridoMapping : EntityTypeConfiguration<tblS_CapacitacionDNRecorrido>
    {
        public CapacitacionDNRecorridoMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionDNRecorrido");
        }
    }
}
