...
{
    public class CapacitacionIHHControlHorasMapping : EntityTypeConfiguration<tblS_CapacitacionIHHControlHoras>
    {
        public CapacitacionIHHControlHorasMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionIHHControlHoras");
        }
    }
}
