...
{
    public class CapacitacionListaAutorizacionAsistentesMapping : EntityTypeConfiguration<tblS_CapacitacionListaAutorizacionAsistentes>
    {
        public CapacitacionListaAutorizacionAsistentesMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionListaAutorizacionAsistentes");
        }
    }
}
