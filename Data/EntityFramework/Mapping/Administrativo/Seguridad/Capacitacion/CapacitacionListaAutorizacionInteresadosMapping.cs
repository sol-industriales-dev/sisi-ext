...
{
    public class CapacitacionListaAutorizacionInteresadosMapping : EntityTypeConfiguration<tblS_CapacitacionListaAutorizacionInteresados>
    {
        public CapacitacionListaAutorizacionInteresadosMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionListaAutorizacionInteresados");
        }
    }
}
