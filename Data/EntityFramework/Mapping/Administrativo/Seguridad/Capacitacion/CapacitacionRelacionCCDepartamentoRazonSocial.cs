...
{
    public class CapacitacionRelacionCCDepartamentoRazonSocialMapping : EntityTypeConfiguration<tblS_CapacitacionRelacionCCDepartamentoRazonSocial>
    {
        public CapacitacionRelacionCCDepartamentoRazonSocialMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionRelacionCCDepartamentoRazonSocial");
        }
    }
}
