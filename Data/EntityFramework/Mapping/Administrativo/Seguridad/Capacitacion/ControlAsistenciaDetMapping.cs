...
{
    public class ControlAsistenciaDetMapping : EntityTypeConfiguration<tblS_CapacitacionControlAsistenciaDetalle>
    {
        public ControlAsistenciaDetMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionControlAsistenciaDetalle");
        }
    }
