...
{
    public class tblS_CapacitacionCursosExamenMapping : EntityTypeConfiguration<tblS_CapacitacionCursosExamen>
    {
        public tblS_CapacitacionCursosExamenMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionCursosExamen");
        }
