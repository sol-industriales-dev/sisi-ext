...
{
    public class tblS_CapacitacionRolesGrupoTrabajoMapping:EntityTypeConfiguration<tblS_CapacitacionRolesGrupoTrabajo>
    {
        public tblS_CapacitacionRolesGrupoTrabajoMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionRolesGrupoTrabajo");
        }
    }
}
