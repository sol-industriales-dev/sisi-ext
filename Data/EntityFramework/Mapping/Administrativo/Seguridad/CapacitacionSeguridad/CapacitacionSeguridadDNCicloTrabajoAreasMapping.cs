...
{
    public class CapacitacionSeguridadDNCicloTrabajoAreasMapping : EntityTypeConfiguration<tblS_CapacitacionSeguridadDNCicloTrabajoAreas>
    {
        public CapacitacionSeguridadDNCicloTrabajoAreasMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionSeguridadDNCicloTrabajoAreas");
        }
    }
}
