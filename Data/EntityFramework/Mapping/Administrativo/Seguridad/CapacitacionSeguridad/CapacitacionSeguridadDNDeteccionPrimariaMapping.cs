...
{
    public class CapacitacionSeguridadDNDeteccionPrimariaMapping : EntityTypeConfiguration<tblS_CapacitacionSeguridadDNDeteccionPrimaria>
    {
        public CapacitacionSeguridadDNDeteccionPrimariaMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionSeguridadDNDeteccionPrimaria");
        }
    }
}
