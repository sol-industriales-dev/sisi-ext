...
{
    public class CapacitacionSeguridadDNDeteccionPrimariaNecesidadMapping : EntityTypeConfiguration<tblS_CapacitacionSeguridadDNDeteccionPrimariaNecesidad>
    {
        public CapacitacionSeguridadDNDeteccionPrimariaNecesidadMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionSeguridadDNDeteccionPrimariaNecesidad");
        }
    }
}
