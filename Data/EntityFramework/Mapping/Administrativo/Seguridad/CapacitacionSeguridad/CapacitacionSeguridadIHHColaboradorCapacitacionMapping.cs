...
{
    public class CapacitacionSeguridadIHHColaboradorCapacitacionMapping : EntityTypeConfiguration<tblS_CapacitacionSeguridadIHHColaboradorCapacitacion>
    {
        public CapacitacionSeguridadIHHColaboradorCapacitacionMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionSeguridadIHHColaboradorCapacitacion");
        }
    }
}
