...
{
    public class CapacitacionSeguridadListaAutorizacionMapping : EntityTypeConfiguration<tblS_CapacitacionSeguridadListaAutorizacion>
    {
        public CapacitacionSeguridadListaAutorizacionMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionSeguridadListaAutorizacion");
        }
    }
}
