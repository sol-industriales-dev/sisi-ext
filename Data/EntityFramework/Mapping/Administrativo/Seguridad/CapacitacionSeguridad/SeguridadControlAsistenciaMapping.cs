...
{
    public class SeguridadControlAsistenciaMapping : EntityTypeConfiguration<tblS_CapacitacionSeguridadControlAsistencia>
    {
        public SeguridadControlAsistenciaMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionSeguridadControlAsistencia");
        }
    }
