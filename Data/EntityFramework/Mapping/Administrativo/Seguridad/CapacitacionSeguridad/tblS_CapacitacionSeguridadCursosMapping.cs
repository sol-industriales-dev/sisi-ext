...
{
    class tblS_CapacitacionSeguridadCursosMapping : EntityTypeConfiguration<tblS_CapacitacionSeguridadCursos>
    {
        public tblS_CapacitacionSeguridadCursosMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionSeguridadCursos");
        }
    }
}
