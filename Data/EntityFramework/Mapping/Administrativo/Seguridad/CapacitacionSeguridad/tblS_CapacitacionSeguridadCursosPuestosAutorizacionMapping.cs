...
{
    public class tblS_CapacitacionSeguridadCursosPuestosAutorizacionMapping : EntityTypeConfiguration<tblS_CapacitacionSeguridadCursosPuestosAutorizacion>
    {
        public tblS_CapacitacionSeguridadCursosPuestosAutorizacionMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_CapacitacionSeguridadCursosPuestosAutorizacion");
        }
    }
}
