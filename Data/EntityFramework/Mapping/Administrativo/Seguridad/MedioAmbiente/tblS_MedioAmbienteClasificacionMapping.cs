...
{
    public class tblS_MedioAmbienteClasificacionMapping : EntityTypeConfiguration<tblS_MedioAmbienteClasificacion>
    {
        public tblS_MedioAmbienteClasificacionMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblS_MedioAmbienteClasificacion");
        }
    }
}
