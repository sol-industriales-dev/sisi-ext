...
{
    public class PreguntasSubContratistaMapping : EntityTypeConfiguration<tblEN_PreguntasSubContratistas>
    {
        public PreguntasSubContratistaMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblEN_PreguntasSubContratistas");
        }
    }
}