...
{
    class FamiliasExcepcionInventariablesMapping : EntityTypeConfiguration<tblCom_FamiliasExcepcionInventariables>
    {
        public FamiliasExcepcionInventariablesMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblCom_FamiliasExcepcionInventariables");
        }
    }
}
