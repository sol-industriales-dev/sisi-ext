...
{
    class FamiliasInventariablesSinValidacionMapping : EntityTypeConfiguration<tblAlm_FamiliasInventariablesSinValidacion>
    {
        public FamiliasInventariablesSinValidacionMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblAlm_FamiliasInventariablesSinValidacion");
        }
    }
}
