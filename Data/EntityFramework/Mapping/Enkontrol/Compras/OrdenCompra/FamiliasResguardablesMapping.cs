...
{
    class FamiliasResguardablesMapping : EntityTypeConfiguration<tblAlm_FamiliasResguardables>
    {
        public FamiliasResguardablesMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblAlm_FamiliasResguardables");
        }
    }
}
