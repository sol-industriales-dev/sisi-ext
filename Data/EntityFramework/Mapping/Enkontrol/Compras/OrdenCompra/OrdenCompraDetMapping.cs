...
{
    class OrdenCompraDetMapping : EntityTypeConfiguration<tblCom_OrdenCompraDet>
    {
        public OrdenCompraDetMapping()
        {
            HasKey(x => x.id);
            ...
            Property(x => x.precio).HasPrecision(24, 6).HasColumnName("precio");
            Property(x => x.importe).HasPrecision(24, 6).HasColumnName("importe");
