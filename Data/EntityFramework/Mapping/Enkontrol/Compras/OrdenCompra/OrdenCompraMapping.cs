...
{
    class OrdenCompraMapping : EntityTypeConfiguration<tblCom_OrdenCompra>
    {
        public OrdenCompraMapping()
        {
            ...
            Property(x => x.PERU_proveedor).HasColumnName("PERU_proveedor");
            Property(x => x.PERU_cuentaCorriente).HasColumnName("PERU_cuentaCorriente");
            Property(x => x.PERU_formaPago).HasColumnName("PERU_formaPago");
            Property(x => x.PERU_tipoCambio).HasColumnName("PERU_tipoCambio");
            Property(x => x.PERU_tipoCompra).HasColumnName("PERU_tipoCompra");

            ToTable("tblCom_OrdenCompra");
        }
    }
}
