...
{
    public class PermisoCierreInventarioMapping : EntityTypeConfiguration<tblAlm_PermisoCierreInventario>
    {
        public PermisoCierreInventarioMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblAlm_PermisoCierreInventario");
        }
    }
}
