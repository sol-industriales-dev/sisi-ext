...
{
    class RetencionesOC_InternaMapping : EntityTypeConfiguration<tblCom_OCRetenciones_Interna>
    {
        public RetencionesOC_InternaMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblCom_OCRetenciones_Interna");
        }
    }
}
