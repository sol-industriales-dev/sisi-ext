...
{
    class Validacion_101_102_InsumosExcepcionesMapping : EntityTypeConfiguration<tblAlm_Validacion_101_102_InsumosExcepciones>
    {
        public Validacion_101_102_InsumosExcepcionesMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblAlm_Validacion_101_102_InsumosExcepciones");
        }
    }
}
