...
{
    class VoboEmpleadoTipoGrupoMapping : EntityTypeConfiguration<tblCom_VoboEmpleadoTipoGrupo>
    {
        public VoboEmpleadoTipoGrupoMapping()
        {
            HasKey(x => x.id);
            ...
            Property(x => x.tipoGrupo).HasColumnName("tipoGrupo");
            Property(x => x.estatus).HasColumnName("estatus");

            ToTable("tblCom_VoboEmpleadoTipoGrupo");
        }
    }
}
