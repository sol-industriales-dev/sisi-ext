...
{
    public class ControlEnvioMaquinariaMapping : EntityTypeConfiguration<tblM_ControlEnvioMaquinaria>
    {
        ControlEnvioMaquinariaMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblM_ControlEnvioMaquinaria");
        }
    }
}
