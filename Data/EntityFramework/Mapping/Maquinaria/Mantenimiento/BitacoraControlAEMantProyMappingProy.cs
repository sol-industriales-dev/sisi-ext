...
{
    class BitacoraControlAEMantProyMappingProy : EntityTypeConfiguration<tblM_BitacoraControlAEMantProy>
    {
        public BitacoraControlAEMantProyMappingProy()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblM_BitacoraControlAEMantProy");
        }
