...
{
    public class tblC_AF_PolizaAltaBaja_ExtrasMapping : EntityTypeConfiguration<tblC_AF_PolizaAltaBaja_Extras>
    {
        public tblC_AF_PolizaAltaBaja_ExtrasMapping()
        {
            HasKey(x => x.Id);
            ...
            ToTable("tblC_AF_PolizaAltaBaja_Extras");
        }
    }
}
