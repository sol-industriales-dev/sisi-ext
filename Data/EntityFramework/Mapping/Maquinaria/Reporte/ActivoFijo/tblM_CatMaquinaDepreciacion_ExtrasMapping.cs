...
{
    public class tblM_CatMaquinaDepreciacion_ExtrasMapping : EntityTypeConfiguration<tblM_CatMaquinaDepreciacion_Extras>
    {
        public tblM_CatMaquinaDepreciacion_ExtrasMapping()
        {
            HasKey(x => x.Id);
            ...
            ToTable("tblM_CatMaquinaDepreciacion_Extras");
        }
    }
}
