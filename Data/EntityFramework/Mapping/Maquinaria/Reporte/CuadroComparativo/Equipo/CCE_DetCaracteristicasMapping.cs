...
{
    public class CCE_DetCaracteristicasMapping : EntityTypeConfiguration<tblM_CCE_DetCaracteristicas>
    {
        public CCE_DetCaracteristicasMapping()
        {
            HasKey(x => x.Id);
            Property(x => x.Id).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity).HasColumnName("Id");
            Property(x => x.IdEquipo).HasColumnName("IdCuadro");
