...
{
    public class tblRH_BN_Evaluacion_AutMapping : EntityTypeConfiguration<tblRH_BN_Evaluacion_Aut>
    {
        public tblRH_BN_Evaluacion_AutMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblRH_BN_Evaluacion_Aut");
        }
    }
}
