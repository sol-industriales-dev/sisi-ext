...
{
    public class tblRH_BN_Plantilla_AutMapping : EntityTypeConfiguration<tblRH_BN_Plantilla_Aut>
    {
        public tblRH_BN_Plantilla_AutMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblRH_BN_Plantilla_Aut");
        }
    }
}
