...
{
    public class tblRH_BN_Plantilla_CuadradoMapping : EntityTypeConfiguration<tblRH_BN_Plantilla_Cuadrado>
    {
        public tblRH_BN_Plantilla_CuadradoMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblRH_BN_Plantilla_Cuadrado");
        }
    }
}
