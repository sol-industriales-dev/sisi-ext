...
{
    public class tblRH_BN_Plantilla_DetMapping : EntityTypeConfiguration<tblRH_BN_Plantilla_Det>
    {
        public tblRH_BN_Plantilla_DetMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblRH_BN_Plantilla_Det");
        }
    }
