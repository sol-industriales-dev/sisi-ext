...
{
    public class tblRH_REC_CatPlataformasMapping : EntityTypeConfiguration<tblRH_REC_CatPlataformas>
    {
        public tblRH_REC_CatPlataformasMapping()
        {
            Property(x => x.id).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity).HasColumnName("id");
            Property(x => x.plataforma).HasColumnName("plataforma");
            ...
            ToTable("tblRH_REC_CatPlataformas");
        }
    }
}
