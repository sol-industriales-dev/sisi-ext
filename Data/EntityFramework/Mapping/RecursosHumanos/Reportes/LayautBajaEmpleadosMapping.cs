...
{
    public class LayautBajaEmpleadosMapping : EntityTypeConfiguration<tblRH_LayautBajaEmpleados>
    {
        public LayautBajaEmpleadosMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblRH_LayautBajaEmpleados");
        }
    }
}
