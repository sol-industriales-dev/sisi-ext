...
{
    public class CapturaMensualArchivoMapping : EntityTypeConfiguration<tblX_CapturaMensualArchivo>
    {
        public CapturaMensualArchivoMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblX_CapturaMensualArchivo");
        }
    }
}
