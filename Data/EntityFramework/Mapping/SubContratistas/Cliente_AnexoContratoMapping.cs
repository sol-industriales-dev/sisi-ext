...
{
    public class Cliente_AnexoContratoMapping : EntityTypeConfiguration<tblX_Cliente_AnexoContrato>
    {
        public Cliente_AnexoContratoMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblX_Cliente_AnexoContrato");
        }
    }
}
