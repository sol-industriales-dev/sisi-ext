...
{
    public class Cliente_CapturaMensualMapping : EntityTypeConfiguration<tblX_Cliente_CapturaMensual>
    {
        public Cliente_CapturaMensualMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblX_Cliente_CapturaMensual");
        }
    }
}
