...
{
    public class Cliente_ContratoPeriodoMapping : EntityTypeConfiguration<tblX_Cliente_ContratoPeriodo>
    {
        public Cliente_ContratoPeriodoMapping()
        {
            HasKey(x => x.id);
            ...
            ToTable("tblX_Cliente_ContratoPeriodo");
        }
    }
}
