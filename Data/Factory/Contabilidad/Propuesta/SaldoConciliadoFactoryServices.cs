...
{
    public class SaldoConciliadoFactoryServices
    {
        public ISaldoConciliadoDAO getSaldoConciliadoService()
        {
            return new SaldoConciliadoServices(new SaldoConciliadoDAO());
        }
    }
}
