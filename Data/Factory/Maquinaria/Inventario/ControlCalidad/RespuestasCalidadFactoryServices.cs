...
{
    public class RespuestasCalidadFactoryServices
    {
        public IRespuestasCalidadDAO getRespuestasCalidadFactoryServices()
        {
            return new RespuestasCalidadService(new RespuestasCalidadDAO());
        }
    }
}
