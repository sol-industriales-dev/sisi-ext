...
using Data.Factory.RecursosHumanos.Capacitacion;
...
namespace SIGOPLAN.Areas.Administrativo.Controllers.RecursosHumanos.Capacitacion
{
    public class CapacitacionCapitalHumanoController : BaseController
    {
        private ICapacitacionCapitalHumanoDAO capacitacionService;
        ...
        protected override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            capacitacionService = new CapacitacionCapitalHumanoFactoryService().GetCapacitacionCapitalHumanoService();
        ...
        {
            return Json(new { items = GlobalUtils.ParseEnumToCombo<Core.Enum.RecursosHumanos.Capacitacion.MandoEnum>() }, JsonRequestBehavior.AllowGet);
        }
        ...
        {
            return Json(capacitacionService.CargarDatosGeneralesDashboard(ccsCplan, ccsArr, fechaInicio, fechaFin, clasificacion), JsonRequestBehavior.AllowGet);
        }
        ...
        [HttpPost]
        public ActionResult CargarDatosMatrizNecesidades(List<string> ccsCplan, List<string> ccsArr, List<string> departamentosIDs, List<ClasificacionCursoEnum> clasificaciones, List<MandoEnum> mandos)
        {
            var jsonResponse = new JsonResult
            {
                Data = capacitacionService.CargarDatosMatrizNecesidades(ccsCplan, ccsArr, departamentosIDs, clasificaciones, mandos),
        ...
        [HttpPost]
        public ActionResult CargarDatosSeccionMatriz(List<string> ccsCplan, List<string> ccsArr, List<string> departamentosIDs, List<ClasificacionCursoEnum> clasificaciones, SeccionMatrizEnum seccion, List<MandoEnum> mandos)
        {
            var jsonResponse = new JsonResult
            {
                Data = capacitacionService.CargarDatosSeccionMatriz(ccsCplan, ccsArr, departamentosIDs, clasificaciones, seccion, mandos),
                JsonRequestBehavior = JsonRequestBehavior.AllowGet,
                MaxJsonLength = int.MaxValue
            };
        ...
        public ActionResult GuardarRegistroCiclo(tblS_CapacitacionDNCicloTrabajoRegistro registroCiclo, List<tblS_CapacitacionDNCicloTrabajoRegistroRevisiones> listaRevisiones, List<tblS_CapacitacionDNCicloTrabajoRegistroPropuestas> listaPropuestas, List<tblS_CapacitacionDNCicloTrabajoRegistroAreas> listaAreas)
        {
            return Json(capacitacionService.guardarRegistroCiclo(registroCiclo, listaRevisiones, listaPropuestas, listaAreas), JsonRequestBehavior.AllowGet);
        }
        ...
        {
            return Json(capacitacionService.getRegistrosRecorridos(listaCC, listaAreas, fecha, realizador), JsonRequestBehavior.AllowGet);
        }
        ...
        {
            return Json(capacitacionService.cargarDashboardRecorridos(listaCC, listaAreas, fecha, realizador), JsonRequestBehavior.AllowGet);
        }
        #endregion
        #endregion
        ...
        {
            return Json(capacitacionService.cargarHorasAdiestramiento(listaCC, fechaInicial, fechaFinal), JsonRequestBehavior.AllowGet);
        }

        public ActionResult GuardarNuevoColaboradorCapacitacion(tblS_CapacitacionIHHColaboradorCapacitacion colaboradorCapacitacion)
        {
            return Json(capacitacionService.guardarNuevoColaboradorCapacitacion(colaboradorCapacitacion), JsonRequestBehavior.AllowGet);
        }
