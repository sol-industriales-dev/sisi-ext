(() => {
    $.namespace('Administrativo.FlujoEfectivo.Reporte');
    Reporte = function () {
        const selCC = $('#selCC');
        ...
        const getMovPolFlujo = new URL(window.location.origin + '/Administrativo/FlujoEfectivo/getMovPolFlujo');
        const getLstAuxAnual = new URL(window.location.origin + '/Administrativo/FlujoEfectivo/getLstAuxAnual');
        const exportFlujoEfectivo = new URL(window.location.origin + '/Administrativo/FlujoEfectivo/exportFlujoEfectivo');
        var year = 2000;
        let init = () => {
            initForm();
    ...
    $(document).ready(() => {
        Administrativo.FlujoEfectivo.Reporte = new Reporte();
    })
