(() => {
$.namespace('Administrativo.FlujoEfectivo._catConceptos');
    _catConceptos = function () {
        ...
        const getCatConcepto = new URL(window.location.origin + '/Administrativo/FlujoEfectivo/getCatConcepto');
        const guardarConcepto = new URL(window.location.origin + '/Administrativo/FlujoEfectivo/guardarConcepto');
        const getComboTipoMovimiento = new URL(window.location.origin + '/Administrativo/Poliza/getComboTipoMovimiento');
        const getCboPadreConcepto = new URL(window.location.origin + '/Administrativo/FlujoEfectivo/getCboPadreConcepto');
        let init = () => {
            initForm();
    ...
    $(document).ready(() => {
        Administrativo.FlujoEfectivo._catConceptos = new _catConceptos();
    })
