(() => {
    $.namespace('Administrativo.FlujoEfectivo._movPoliza');
    _movPoliza = function () {
        ...
        const getLstMovPoliza = new URL(window.location.origin + '/Administrativo/FlujoEfectivo/getLstMovPoliza');
        const getGuardadoEstado = new URL(window.location.origin + '/Administrativo/FlujoEfectivo/getGuardadoEstado');
        const getPeriodoContable = new URL(window.location.origin + '/Administrativo/FlujoEfectivo/getPeriodoContable');
        const getCboTipoBusqueda = new URL(window.location.origin + '/Administrativo/FlujoEfectivo/getCboTipoBusqueda');
        ...
        function initForm() {
            selMpCc.fillCombo(getCC, null, true, null);
    ...
    $(document).ready(() => {
        Administrativo.FlujoEfectivo._movPoliza = new _movPoliza();
    })
