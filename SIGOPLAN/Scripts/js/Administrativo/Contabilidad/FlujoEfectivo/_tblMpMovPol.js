(() => {
    $.namespace('Administrativo.FlujoEfectivo._tblMpMovPol');
    _tblMpMovPol = function () {
        ...
        const guardarCorte = new URL(window.location.origin + '/Administrativo/FlujoEfectivo/guardarCorte');
        const guardarMovPol = new URL(window.location.origin + '/Administrativo/FlujoEfectivo/guardarMovPol');
        const getCorteEstado = new URL(window.location.origin + '/Administrativo/FlujoEfectivo/getCorteEstado');
        const getIniTblPoliza = new URL(window.location.origin + '/Administrativo/FlujoEfectivo/getIniTblPoliza');
    ...
    $(document).ready(() => {
        Administrativo.FlujoEfectivo._tblMpMovPol = new _tblMpMovPol();
    })
