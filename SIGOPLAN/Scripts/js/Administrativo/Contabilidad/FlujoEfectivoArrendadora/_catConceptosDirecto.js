(() => {
    $.namespace('Administrativo.FlujoEfectivoArrendadora._catConceptosDirecto');
    _catConceptosDirecto = function () {
        ...
        const getCatConceptoDir = new URL(window.location.origin + '/Administrativo/FlujoEfectivoArrendadora/getCatConceptoDir');
        const guardarConceptoDir = new URL(window.location.origin + '/Administrativo/FlujoEfectivoArrendadora/guardarConceptoDir');
        const getComboTipoMovimiento = new URL(window.location.origin + '/Administrativo/Poliza/getComboTipoMovimiento');
        const getCboPadreConceptoDir = new URL(window.location.origin + '/Administrativo/FlujoEfectivoArrendadora/getCboPadreConceptoDir');
        const getCboOperadorConcepto = new URL(window.location.origin + '/Administrativo/FlujoEfectivoArrendadora/getCboOperadorConcepto');
        let init = () => {
            initForm();
    ...
    $(document).ready(() => {
        Administrativo.FlujoEfectivoArrendadora._catConceptosDirecto = new _catConceptosDirecto();
    })
