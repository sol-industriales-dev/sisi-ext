(() => {
    $.namespace('Administrativo.Nomina.AutorizaBajasCH');
    AutorizaBajasCH = function () {
        //#region Selectores
        ...
        function cargarEmpleados() {
            $.post('/Administrativo/Nomina/GetEmpleadosPendientesLiberacion').then(response => {
                if (response.success) {
        ...
        function guardarBajas() {
            ...
            if (empleados.length > 0) {
                $.post('/Administrativo/Nomina/GuardarBajas', { empleados }).then(response => {
                    if (response.success) {
    ...
    $(document).ready(() => Administrativo.Nomina.AutorizaBajasCH = new AutorizaBajasCH())
