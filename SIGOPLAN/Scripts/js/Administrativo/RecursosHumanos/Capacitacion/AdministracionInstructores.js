    ...
    Promedio = function () {
        ...
        function fncEliminar(id) {
            ...
            $.ajax({
                datatype: "json",
                type: "GET",
                url: "/Administrativo/Capacitacion/EliminarInstructor",
                data: datos,
        ...
        function cargarEmpleados() {
            axios.post('/Administrativo/Capacitacion/GetInstructores')
                .then(response => {
        ...
        function cargarEmpleadoPorClave() {
            ...
            if (cveEmpleado > 0) {
                ...
                $.post('/Administrativo/Capacitacion/ObtenerCCUnico', { cveEmpleado })
                    .always($.unblockUI)
                    .then(response => {
                        if (response.success) {
        ...
        function GuardarCveEmpleado() {
            if ($('#inputClaveEmpleado').val() == "") {
                ...
                axios.post('/Administrativo/Capacitacion/PostGuardarInstructor', { parametros: parametros, AddEdit: AddEdit })
        ...
        function getFechaInicio(cveEmpleado) {
            axios.post('/Administrativo/Capacitacion/getFechaInicio', { cveEmpleado: cveEmpleado })
                .catch(o_O => AlertaGeneral(o_O.message))
                .then(response => {
        ...
        let init = () => {
            ...
            selectGrupo.fillCombo('/Administrativo/Capacitacion/GetRolesCombo', null, false);
            ...
            cboProyecto.change(function (e) {
                cboInstructor.fillCombo('/Administrativo/Capacitacion/GetInstructoresCombo?cc=' + $('#cboProyecto').val() + '', null, false);
            });
        }
