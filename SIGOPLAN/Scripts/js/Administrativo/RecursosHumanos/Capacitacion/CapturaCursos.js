(function () {
    ...
    $.namespace('administrativo.RecursosHumanos.Capacitacion.CapturaCursos');
    ...
    CapturaCursos = function () {
        ...
        //#region PETICIONES
        const getCursos = (clasificaciones, puestos, estatus) => { return $.post('/Administrativo/CapacitacionCapitalHumano/GetCursos', { clasificaciones, puestos, estatus }) };
        const getTipoExamen = (curso_id) => { return $.post('/Administrativo/CapacitacionCapitalHumano/GetTipoExamen', { curso_id }) };
        const GuardarCurso = (curso) => { return $.post('/Administrativo/CapacitacionCapitalHumano/GuardarCurso', { curso }) };
        const ActualizarCurso = (curso, mandos, puestosNuevos, puestosAutorizacionNuevos, centrosCosto) => {
            return $.post('/Administrativo/CapacitacionCapitalHumano/ActualizarCurso', { curso, mandos, puestosNuevos, puestosAutorizacionNuevos, centrosCosto })
        };
        const GuardarExamenes = (examenes) => { return $.post('/Administrativo/CapacitacionCapitalHumano/GuardarExamenes', { examenes }) };
        const DescargarArchivo = (examen_id) => { return $.post('/Administrativo/CapacitacionCapitalHumano/DescargarArchivo', { examen_id }) };
        const EliminarExamen = (examen_id) => { return $.post('/Administrativo/CapacitacionCapitalHumano/EliminarExamen', { examen_id }) };
        //const getClasificacion = () => { return $.post('/Administrativo/CapacitacionCapitalHumano/GetClasificacionCursos') };
        //#endregion
        ...
        function eliminarCurso(cursoID) {
            ...
            $.post('/Administrativo/CapacitacionCapitalHumano/EliminarCurso', { cursoID })
                .then(response => {
                    if (response.success) {
                        // Operación exitosa.
        ...
        function guardarCargaMasiva() {
            ...
            request.open("POST", "/Administrativo/CapacitacionCapitalHumano/GuardarCargaMasivaRelacionCursosPuestosAutorizacion");
    ...
    $(document).ready(function () {
        administrativo.RecursosHumanos.Capacitacion.CapturaCursos = new CapturaCursos();
    });
})();
