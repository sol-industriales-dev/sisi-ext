(() => {
    $.namespace('Adminstrativo.RecursosHumanos.Capacitacion.ControlAsistencia');

    ControlAsistencia = function () {

        // Variables.
        //// Url autocompletes
        const getCursosAutocompleteURL = '/Administrativo/CapacitacionCapitalHumano/GetCursosAutocomplete';
        const getUsuariosAutocompleteURL = '/Administrativo/CapacitacionCapitalHumano/GetUsuariosAutocomplete';
        const getGetLugarCursoAutocompleteURL = '/Administrativo/CapacitacionCapitalHumano/GetLugarCursoAutocomplete';
        const getEmpleadoEnKontrolAutocompleteURL = '/Administrativo/CapacitacionCapitalHumano/GetEmpleadoEnKontrolAutocomplete';
        ...
        function guardarExamenesAsistentes() {
            ...
            if (esCursoGeneral) {
                ...
                for (let index = 0; index < asistentes.length; index++) {
                    ...
                    $.ajax({
                        url: '/Administrativo/CapacitacionCapitalHumano/CargarExamenesAsistente',
                        data,
                        async: false,
                        cache: false,
                        contentType: false,
                ...
                $.post('/Administrativo/CapacitacionCapitalHumano/GuardarExamenesAsistentes', { jefeID, coordinadorID, secretarioID, gerenteID, rfc, razonSocial })
                    .always($.unblockUI)
                    .then(response => {
                        if (response.success) {
                            // Operación exitosa.
            ...
            for (let index = 0; index < asistentes.length; index++) {
                ...
                if (inputFile != undefined) {
                    ...
                    if (archivoDC3 != undefined) {
                        ...
                        $.ajax({
                            url: '/Administrativo/CapacitacionCapitalHumano/GuardarArchivosDC3',
                            data,
                            async: false,
                            cache: false,
                            contentType: false,
        ...
        function guardarEvaluacionesAsistentes() {
            ...
            $.post('/Administrativo/CapacitacionCapitalHumano/GuardarEvaluacionAsistentes', { listaAsistentes })
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
                        // Operación exitosa.
        ...
        function crearListaAsistencia() {
            ...
            $.post('/Administrativo/CapacitacionCapitalHumano/CrearControlAsistencia', { controlAsistencia })
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
                        // Operación exitosa.
        ...
        function enviarCorreoAut(controlAsistenciaID) {
            $.post('/Administrativo/CapacitacionCapitalHumano/EnviarCorreoAutorizacion', { controlAsistenciaID })
                .always(() => {
                    $.unblockUI();
                    cargarListaControlAsistencia();
                })
        ...
        function cargarListaControlAsistencia() {
            ...
            $.get('/Administrativo/CapacitacionCapitalHumano/ObtenerListaControlesAsistencia', { cc, estado, fechaInicio, fechaFin })
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
                        // Operación exitosa.
        ...
        function llenarCombos() {
            selectRazonSocial.fillCombo('/Administrativo/CapacitacionCapitalHumano/GetRazonSocialCombo', null, false, null);
            ...
            // $.get('/Administrativo/CapacitacionCapitalHumano/ObtenerComboCCAmbasEmpresas')
            //     .then(response => {
            //         if (response.success) {
            //             // Operación exitosa.
            ...
            $.get('/Administrativo/CapacitacionCapitalHumano/ObtenerEstatusControlAsistencia')
                .always($.unblockUI)
                .then(response => {
                    if (response) {
                        // Operación exitosa.
        ...
        function cargarArchivoControlAsistencia() {
            ...
            $.ajax({
                url: '/Administrativo/CapacitacionCapitalHumano/SubirArchivoControlAsistencia',
                data,
                cache: false,
                contentType: false,
                processData: false,
        ...
        function eliminarControlAsistencia(controlAsistenciaID) {
            ...
            $.post('/Administrativo/CapacitacionCapitalHumano/EliminarControlAsistencia', { controlAsistenciaID })
                .then(response => {
                    if (response.success) {
                        // Operación exitosa.
        ...
        function cargarAsistentes(controlAsistencia) {
            ...
            $.get('/Administrativo/CapacitacionCapitalHumano/CargarAsistentesCapacitacion', { controlAsistenciaID: controlAsistencia.id })
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
                        // Operación exitosa.
        ...
        function cargarDatosControlAsistencia(controlAsistenciaID) {
            ...
            $.get('/Administrativo/CapacitacionCapitalHumano/CargarDatosControlAsistencia', { controlAsistenciaID })
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
                        // Operación exitosa.
        ...
        function guardarCargaMasiva() {
            ...
            request.open("POST", "/Administrativo/CapacitacionCapitalHumano/GuardarCargaMasivaControlAsistencia");
    ...
    $(() => Adminstrativo.RecursosHumanos.Capacitacion.ControlAsistencia = new ControlAsistencia());
})();