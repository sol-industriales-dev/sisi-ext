(() => {
    $.namespace('Administrativo.RecursosHumanos.Capacitacion.MatrizEmpleados');
    ...
    MatrizEmpleados = function () {
        ...
        function llenarCombos() {
            ...
            comboPuesto.fillCombo('/Administrativo/CapacitacionCapitalHumano/GetPuestos', null, false, 'Todos');
        ...
        function obtenerEmpleados() {
            ...
            $.post('/Administrativo/CapacitacionCapitalHumano/ObtenerEmpleados', { ccsCplan, ccsArr, puestos })
                .always($.unblockUI)
                .then(response => {
                    if (response) {
                        // Operación exitosa.
        ...
        function eliminarEvidenciaExtracurricular(extracurricularID, claveEmpleado) {
            $.post('/Administrativo/CapacitacionCapitalHumano/EliminarEvidenciaExtracurricular', { extracurricularID })
                .then(response => {
                    if (response.success) {
                        // Operación exitosa.
        ...
        function cargarCursosEmpleado(empleado) {
            ...
            $.get('/Administrativo/CapacitacionCapitalHumano/ObtenerCursosEmpleado', { claveEmpleado, puestoID })
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
                        // Operación exitosa.
        ...
        function cargarExtracurricularesEmpleado(claveEmpleado) {
            ...
            $.get('/Administrativo/CapacitacionCapitalHumano/ObtenerExtracurricularesEmpleado', { claveEmpleado })
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
        ...
        function guardarExtracurricular() {
            ...
            $.ajax({
                url: '/Administrativo/CapacitacionCapitalHumano/SubirEvidenciaExtracurricular',
                data,
                cache: false,
                contentType: false,
                processData: false,
    ...
    $(() => Administrativo.RecursosHumanos.Capacitacion.MatrizEmpleados = new MatrizEmpleados());
})();