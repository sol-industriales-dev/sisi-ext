(() => {
    ...
    RetardosGestion = function () {
        ...
        function initTblRH_Vacaciones_Vacaciones() {
            dtRH_Vacaciones_Vacaciones = tblRH_Vacaciones_Vacaciones.DataTable({
                ...
                columns: [
                        ...
                        render: function (data, type, row) {
                            ...
                            switch (row.tipoRetardo) {
                                case 0:
                                    ...
                                    break;
                                case 1:
                                    vacacionesDesc = "Jornada laboral"
                                    break;
                            }
                    ...
                    {
                        data: 'diaTomado', title: "Dia Tomado",
                        render: function (data, type, row, meta) {
                ...
                initComplete: function (settings, json) {
                    tblRH_Vacaciones_Vacaciones.on('click', '.autorizarVacacion', function () {
                        ...
                        Alert2AccionConfirmar('¡Cuidado!', '¿Desea autorizar la Justificacion seleccionada?', 'Confirmar', 'Cancelar', () => fncAutorizarVacacion(rowData.id, 1, ""));
                    ...
                    tblRH_Vacaciones_Vacaciones.on('click', '.rechazarVacacion', function () {
                        ...
                        Swal.fire({
                            ...
                            html: "<h3>¿Desea rechazar la justificacion seleccionado?<br>Indicar el motivo:</h3> ",
                            ...
                            if (result.isConfirmed) {
                                fncAutorizarVacacion(rowData.id, 2, $('.swal2-textarea').val());
                            }
                        });
                    });
        ...
        function fncGetVacaciones() {
            ...
            axios.post("GetRetardosGestion", objFiltro).then(response => {
        ...
        function fncAutorizarVacacion(idVac, estadoNum, mensaje) {
            obj = {
                id: idVac,
                estado: estadoNum,
                msg: mensaje
            ...
            axios.post("AutorizarRetardo", obj).then(response => {
                let { success, items, message } = response.data;
                if (success) {
                    switch (estadoNum) {
                        case 1:
                            Alert2Exito("Justificante autorizado");
                            break;
                        case 2:
                            Alert2Exito("Justificante rechazado");
                            break;
                    }
    ...
    $(document).ready(() => {
        CH.RetardosGestion = new RetardosGestion();
    })
