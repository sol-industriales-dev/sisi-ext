(() => {
    $.namespace('Adminstrativo.Seguridad.Capacitacion.AutorizacionCapacitacion');
    ...
    AutorizacionCapacitacion = function () {
        ...
        function llenarCombos() {
            ...
            $.get('/Administrativo/Capacitacion/ObtenerComboCC')
                ...
                .then(response => {
                    if (response.success) {
                        ...
                        $.blockUI({ message: 'Cargando...' });
                        $.get('/Administrativo/Capacitacion/ObtenerComboEstatusAutorizacionCapacitacion')
                            .always($.unblockUI)
                            .then(response => {
                                if (response.success) {
                                    // Operación exitosa.
            ...
            comboCurso.fillCombo('/Administrativo/Capacitacion/ObtenerComboCursos', null, false, null);
        }
        ...
        function obtenerAutorizaciones() {
            ...
            $.blockUI({ message: 'Cargando...' });
            $.get('/Administrativo/Capacitacion/ObtenerAutorizaciones', { cc, curso, estatus })
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
                        // Operación exitosa.
        ...
        function obtenerListaAutorizantes(capacitacionID) {
            ...
            $.get('/Administrativo/Capacitacion/ObtenerAutorizantes', { capacitacionID })
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
                        // Operación exitosa.
        ...
        function autorizarControlAsistencia() {
            ...
            if (controlAsistenciaID && controlAsistenciaID > 0) {
                ...
                $.post('/Administrativo/Capacitacion/AutorizarControlAsistencia', { controlAsistenciaID })
                    .always($.unblockUI)
                    .then(response => {
                        if (response.success) {
                            // Operación exitosa.
        ...
        function rechazarControlAsistencia() {
            ...
            $.post('/Administrativo/Capacitacion/RechazarControlAsistencia', { controlAsistenciaID, comentario })
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
                        // Operación exitosa.
        ...
        function enviarCorreoRechazo(controlAsistenciaID) {
            $.post('/Administrativo/Capacitacion/EnviarCorreoRechazo', { controlAsistenciaID })
                .always(() => {
                    $.unblockUI();
                    ocultarPaneles();
                    obtenerAutorizaciones();
        ...
        function enviarCorreoAutCompleta(controlAsistenciaID) {
            $.post('/Administrativo/Capacitacion/EnviarCorreoAutorizacionCompleta', { controlAsistenciaID })
                .always(() => {
                    $.unblockUI();
                    ocultarPaneles();
                    obtenerAutorizaciones();
    ...
    $(() => Adminstrativo.Seguridad.Capacitacion.AutorizacionCapacitacion = new AutorizacionCapacitacion());
})();