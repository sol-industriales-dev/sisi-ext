(() => {
    ...
    CrearPersonalAutorizado = function () {
            ...
            axios.get('GetDepartamentosCombo')
                .then(response => {
                    ...
                    if (success) {
                        ...
                        selectDepartamentoCaptura.select2().change(); //convertToMultiselect('#selectDepartamentoCaptura');
                    } else {
                        AlertaGeneral(`Alerta`, message);
                    }
                }).catch(error => AlertaGeneral(`Alerta`, error.message));
        ...
        function limpiarModal() {
            ...
            selectDepartamentoCaptura.select2().change();
        ...
        function llenarModal(datos) {
            ...
            let listaDepartamentosSeleccionados = [];
            ...
            selectDepartamentoCaptura.find('option').each((index, element) => {
                ...
                if (datos.listaCC.some(x => x.cc == cc && x.empresa == empresa && x.departamento == departamento)) {
                    ...
                    listaDepartamentosSeleccionados.push($(element).val());
                }
            });

            selectDepartamentoCaptura.val(listaDepartamentosSeleccionados);
            selectDepartamentoCaptura.select2().change();// selectDepartamentoCaptura.multiselect('refresh');
            //#endregion
