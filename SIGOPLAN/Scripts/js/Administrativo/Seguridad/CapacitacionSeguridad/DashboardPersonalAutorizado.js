(() => {
    $.namespace('Adminstrativo.Seguridad.CapacitacionSeguridad.DashboardPersonalAutorizado');
    ...
    $(document).ready(() => Adminstrativo.Seguridad.CapacitacionSeguridad.DashboardPersonalAutorizado = new DashboardPersonalAutorizado())
})();