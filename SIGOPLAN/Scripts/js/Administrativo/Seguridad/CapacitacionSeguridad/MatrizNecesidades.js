(() => {
    $.namespace('Administrativo.Seguridad.CapacitacionSeguridad.MatrizNecesidades');
    ...
    MatrizNecesidades = function () {
        ...
        function llenarCombos() {
            ...
            // comboArea.fillCombo('/Administrativo/CapacitacionSeguridad/GetAreas', null, false, 'Todos');
            convertToMultiselect('#comboArea');
            comboClasificacion.fillCombo('/Administrativo/CapacitacionSeguridad/GetClasificacionCursos', null, false, 'Todos');
            convertToMultiselect('#comboClasificacion');
            if (idEmpresa == 6) {
                comboCplan.fillCombo('/Administrativo/CapacitacionSeguridad/ObtenerComboCCEnKontrol', { empresa: 6 }, false, 'Todos');
        ...
        function cargarDatosMatrizNecesidades() {
            ...
            axios.post('/Administrativo/CapacitacionSeguridad/CargarDatosMatrizNecesidades', { ccsCplan, ccsArr, departamentosIDs, clasificaciones })
                .then(response => {
        ...
        function cargarDatosSeccion(seccion) {
            ...
            axios.post('/Administrativo/CapacitacionSeguridad/CargarDatosSeccionMatriz', { ccsCplan, ccsArr, departamentosIDs, clasificaciones, seccion })
                .then(response => {
                    let { success, datos, message } = response.data;
    ...
    $(() => Administrativo.Seguridad.CapacitacionSeguridad.MatrizNecesidades = new MatrizNecesidades())
