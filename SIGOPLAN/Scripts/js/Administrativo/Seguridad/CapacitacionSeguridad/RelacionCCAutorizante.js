(() => {
    $.namespace('Administrativo.CapacitacionSeguridad.RelacionCCAutorizante');
    RelacionCCAutorizante = function () {
        ...
        (function init() {
            ...
            selectTipoPuesto.fillCombo('/Administrativo/CapacitacionSeguridad/GetTipoPuestoCombo', null, false, null);
        ...
        function cargarRelaciones() {
            ...
            $.post('/Administrativo/CapacitacionSeguridad/GetRelacionesCCAutorizantes')
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
        ...
        function nuevaRelacion() {
            ...
            $.blockUI({ message: 'Procesando...', baseZ: 2000 });
            $.post('/Administrativo/CapacitacionSeguridad/GuardarNuevaRelacionCCAutorizante', { relacion })
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
        ...
        function editarRelacion() {
            ...
            $.blockUI({ message: 'Procesando...', baseZ: 2000 });
            $.post('/Administrativo/CapacitacionSeguridad/EditarRelacionCCAutorizante', { relacion })
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
                        modalRelacion.modal('hide');
        ...
        function eliminarRelacion(id) {
            ...
            $.blockUI({ message: 'Procesando...', baseZ: 2000 });
            $.post('/Administrativo/CapacitacionSeguridad/EliminarRelacionCCAutorizante', { relacion })
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
                        AlertaGeneral(`Alerta`, `Se ha guardado la información.`);
        ...
        function cargarUsuarioPorClave() {
            ...
            if (claveEmpleado > 0) {
                $.blockUI({ message: 'Procesando...', baseZ: 2000 });
                $.post('/Administrativo/CapacitacionSeguridad/GetUsuarioPorClave', { claveEmpleado })
                    .always($.unblockUI)
                    .then(response => {
                        if (response.success) {
    ...
    $(document).ready(() => Administrativo.CapacitacionSeguridad.RelacionCCAutorizante = new RelacionCCAutorizante())
