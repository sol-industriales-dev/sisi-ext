(() => {
    $.namespace('Administrativo.CapacitacionSeguridad.RelacionCCDepartamentoRazonSocial');
    RelacionCCDepartamentoRazonSocial = function () {
        ...
        (function init() {
            ...
            selectRazonSocialEditar.fillCombo('/Administrativo/CapacitacionSeguridad/GetRazonSocialCombo', null, false, null);
        ...
        function cargarRelaciones() {
            ...
            $.post('/Administrativo/CapacitacionSeguridad/GetRelacionesCCDepartamentoRazonSocial')
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
        ...
        function nuevaRelacion() {
            ...
            $.blockUI({ message: 'Procesando...', baseZ: 2000 });
            $.post('/Administrativo/CapacitacionSeguridad/GuardarNuevaRelacionCCDepartamentoRazonSocial', { relaciones })
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
        ...
        function editarRelacion() {
            ...
            $.blockUI({ message: 'Procesando...', baseZ: 2000 });
            $.post('/Administrativo/CapacitacionSeguridad/EditarRelacionCCDepartamentoRazonSocial', { relacion })
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
        ...
        function eliminarRelacion(id) {
            ...
            $.blockUI({ message: 'Procesando...', baseZ: 2000 });
            $.post('/Administrativo/CapacitacionSeguridad/EliminarRelacionCCDepartamentoRazonSocial', { relacion })
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
                        AlertaGeneral(`Alerta`, `Se ha guardado la información.`);
        ...
        function llenarComboDepartamentos() {
            ...
            $.blockUI({ message: 'Procesando...', baseZ: 2000 });
            $.post('/Administrativo/CapacitacionSeguridad/GetDepartamentosCombo')
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
                        //#region Construplan
    ...
    $(document).ready(() => Administrativo.CapacitacionSeguridad.RelacionCCDepartamentoRazonSocial = new RelacionCCDepartamentoRazonSocial())
