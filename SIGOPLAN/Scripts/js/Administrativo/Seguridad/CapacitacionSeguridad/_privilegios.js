(() => {
    $.namespace('Administrativo.Seguridad.CapacitacionSeguridad._privilegios');
    _privilegios = function () {
        ...
        const getCboCC = new URL(window.location.origin + '/Administrativo/CapacitacionSeguridad/ObtenerComboCC');
        const getCboPrivilegios = new URL(window.location.origin + '/Administrativo/CapacitacionSeguridad/getCboPrivilegios');
        const guardarEmpleadosPrivilegios = new URL(window.location.origin + '/Administrativo/CapacitacionSeguridad/guardarEmpleadosPrivilegios');
        const ObtenerEmpleadosPrivilegios = new URL(window.location.origin + '/Administrativo/CapacitacionSeguridad/ObtenerEmpleadosPrivilegios');
    ...
    $(document).ready(() => {
        Administrativo.Seguridad.CapacitacionSeguridad._privilegios = new _privilegios();
    })
