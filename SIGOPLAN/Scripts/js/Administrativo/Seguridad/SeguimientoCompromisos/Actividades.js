(() => {
    $.namespace('SeguimientoCompromisos.Actividades');
    Actividades = function () {
        ...
        (function init() {
            ...
            selectArea.fillCombo('/Administrativo/SeguimientoCompromisos/GetAreaCombo', null, false, null);
            selectAreaEvaluadora.fillCombo('/Administrativo/SeguimientoCompromisos/GetAreaCombo', null, false, null);
            selectClasificacion.fillCombo('/Administrativo/SeguimientoCompromisos/GetClasificacionCombo', null, false, null);
        })();
        ...
        function cargarActividades() {
            ...
            $.post('/Administrativo/SeguimientoCompromisos/GetActividades')
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
        ...
        function nuevaActividad() {
            ...
            $.blockUI({ message: 'Procesando...', baseZ: 2000 });
            $.post('/Administrativo/SeguimientoCompromisos/GuardarNuevaActividad', { actividad })
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
        ...
        function editarActividad() {
            ...
            $.blockUI({ message: 'Procesando...', baseZ: 2000 });
            $.post('/Administrativo/SeguimientoCompromisos/EditarActividad', { actividad })
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
                        modalActividad.modal('hide');
        ...
        function eliminarActividad(id) {
            ...
            $.blockUI({ message: 'Procesando...', baseZ: 2000 });
            $.post('/Administrativo/SeguimientoCompromisos/EliminarActividad', { actividad })
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
                        AlertaGeneral(`Alerta`, `Se ha guardado la información.`);
    ...
    $(document).ready(() => SeguimientoCompromisos.Actividades = new Actividades())
