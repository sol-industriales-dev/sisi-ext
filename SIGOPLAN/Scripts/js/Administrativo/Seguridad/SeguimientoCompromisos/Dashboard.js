(() => {
    $.namespace('SeguimientoCompromisos.Dashboard');
    Dashboard = function () {
        //#region Selectores
        ...
        (function init() {
            ...
            selectCentroCosto.fillCombo('/Administrativo/SeguimientoCompromisos/GetAgrupacionCombo', null, false, '');
        ...
        function cargarResultados() {
            ...
            axios.post('/Administrativo/SeguimientoCompromisos/CargarDashboard', { listaAgrupaciones })
                .then(response => {
    ...
    $(document).ready(() => SeguimientoCompromisos.Dashboard = new Dashboard())
