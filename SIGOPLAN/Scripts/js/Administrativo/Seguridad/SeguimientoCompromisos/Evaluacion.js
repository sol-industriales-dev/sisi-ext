(() => {
    $.namespace('SeguimientoCompromisos.Evaluacion');
    Evaluacion = function () {
        //#region Selectores
        ...
        function cargarEvidencias() {
            ...
            axios.post('/Administrativo/SeguimientoCompromisos/GetActividadesEvaluacion', { agrupacion_id: +selectCentroCosto.getAgrupador(), estatus })
                .then(response => {
                    let { success, datos, message } = response.data;
        ...
        function guardarEvaluacion() {
            ...
            if (evaluaciones.length > 0) {
                axios.post('/Administrativo/SeguimientoCompromisos/GuardarEvaluaciones', { evaluaciones })
                    .then(response => {
                        let { success, datos, message } = response.data;
    ...
    $(document).ready(() => SeguimientoCompromisos.Evaluacion = new Evaluacion())
