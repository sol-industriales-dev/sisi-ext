(() => {
    $.namespace('SeguimientoCompromisos.RelacionEmpleadoAreaAgrupacion');
    ...
    RelacionEmpleadoAreaAgrupacion = function () {
        ...
        function cargarRelaciones() {
            ...
            $.post('/Administrativo/SeguimientoCompromisos/GetRelacionesEmpleadoAreaAgrupacion')
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
        ...
        function nuevaRelacion() {
            ...
            $.blockUI({ message: 'Procesando...', baseZ: 2000 });
            $.post('/Administrativo/SeguimientoCompromisos/GuardarNuevaRelacion', { relacion })
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
        ...
        function editarRelacion() {
            ...
            $.blockUI({ message: 'Procesando...', baseZ: 2000 });
            $.post('/Administrativo/SeguimientoCompromisos/EditarRelacion', { relacion })
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
                        modalRelacion.modal('hide');
        ...
        function eliminarRelacion(id) {
            ...
            $.blockUI({ message: 'Procesando...', baseZ: 2000 });
            $.post('/Administrativo/SeguimientoCompromisos/EliminarRelacion', { relacion })
                .always($.unblockUI)
                .then(response => {
                    if (response.success) {
                        AlertaGeneral(`Alerta`, `Se ha guardado la información.`);
        ...
        function cargarEmpleadoPorClave() {
            ...
            if (claveEmpleado > 0) {
                $.blockUI({ message: 'Procesando...', baseZ: 2000 });
                $.post('/Administrativo/SeguimientoCompromisos/GetUsuarioPorClave', { claveEmpleado })
                    .always($.unblockUI)
                    .then(response => {
                        if (response.success) {
    ...
    $(document).ready(() => SeguimientoCompromisos.RelacionEmpleadoAreaAgrupacion = new RelacionEmpleadoAreaAgrupacion())
