$(function () {
    ...
    $("#btnModalGuardar").on('click', function () {
        $('#modalAltaObra').modal('hide');
        limpiar();
        ConfirmacionGeneral("Confirmación", "  El centro de costos fue agregado correctamente", "bg-green");
    });

    function limpiar() {
        $('#frmControlObra')[0].reset();
    }
