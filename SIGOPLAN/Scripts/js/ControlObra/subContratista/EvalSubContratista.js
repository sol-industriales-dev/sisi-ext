(() => {
    $.namespace('subContratistas.ControlObra');
        ...
        function fillCombos() {
            ...
            cboSubContratista.fillCombo('getSubContratistas', null, false, null);
        }
        function fncButtons() {
            btnBuscar.click(function () {
                obtenerValuesInputs(btnBuscar.attr('data-id'));
            })
        }
                ...
                let html = ``;
                    ...
                    <div class="col-xs-12 col-md-6">
                        <div class="input-group">
                            ...
                            <input name="" id="inpPromedio" class="form-control"/>
                        </div>
                    </div>
                    `;
        ...
        function getParameters() {
            let item = {
                tipoEvaluacion:btnBuscar.attr('data-id'),
            }
            return item;
        }
