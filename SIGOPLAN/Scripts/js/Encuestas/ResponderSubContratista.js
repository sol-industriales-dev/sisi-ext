(function () {
    ...
    responder = function () {
        ...
        txtAsunto = $("#txtAsunto"),
        txtComentario = $("#txtComentarioSub"),
        asunto = $(".asunto"),
        Preguntas = $(".Preguntas");


        //Elementos de Encabezado
        tbFechaEvaluacion = $("#tbFechaEvaluacion"),
        tbNombreSubContratista = $("#tbNombreSubContratista"),
        tbNoContrato = $("#tbNoContrato"),
        tbServicioContratado = $("#tbServicioContratado"),
        tbNombreProyecto = $("#tbNombreProyecto"),
        ...
        function cargarEncuesta() {
            ...
            var numContrato = $.urlParam('numContrato');
            ...
            if (id != null) {
                $.ajax({
                    ...
                    data: { idEncuesta: id, numContrato: numContrato, CC: centrocostos },
                    asyn: false,
                    success: function (response) {
                        ...
                        if (response.RespuestaEncuesta) {
                            ...
                            tbNombreSubContratista.attr('data-convenio', proveedoresData.convenio);
                            ...
                            tbNombreProyecto.val(proveedoresData.nombreProyecto);
                            asunto.show();
