(function () {
    ...
    grupoInsumo = function () {
        id = 0,
        Actualizacion = 1,
        ruta = '/Enkontrol/Almacen/FillGrid_InsumoFamilia';
        estatus = {
            ACTIVO: '1',
            INACTIVO: '0'
        ...
        function getPlainObject() {
            return {
                Id: id,
                tipo_insumo: txtModaltipo.val(),
                grupo_insumo: txtModalgrupo.val(),
        ...
        function getFiltrosObject() {
            return {
                Id: 0,
                tipo_insumo: txttipo.val() == '' ? 0 : txttipo.val(),
                grupo_insumo: txtgrupo.val() == '' ? 0 : txtgrupo.val(),
        ...
        function saveOrUpdate(obj) {
            ...
            $.ajax({
                url: '/Enkontrol/Almacen/SaveOrUpdate_InsumoFamilia',
                type: 'POST',
                dataType: 'json',
