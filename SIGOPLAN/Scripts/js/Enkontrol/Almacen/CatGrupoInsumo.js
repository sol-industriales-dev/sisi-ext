(function () {
    ...
    grupoInsumo = function () {
        id = 0,
        Actualizacion = 1,
        ruta = '/Enkontrol/Almacen/FillGrid_InsumoGrupo';
        estatus = {
            ACTIVO: '1',
            INACTIVO: '0'
        ...
        function openModal() {
            reset();
            tituloModal.text("Alta grupo de Insumo");
            cboModalEstatus.prop('disabled', true);
            modalAlta.modal('show');
        }
        function update() {
            
            tituloModal.text("Actualizar grupo de Insumo");
        ...
        function saveOrUpdate(obj) {
            ...
            $.ajax({
                url: '/Enkontrol/Almacen/SaveOrUpdate_InsumoGrupo',
                type: 'POST',
                dataType: 'json',
