(function () {
    ...
    $.namespace('maquinaria.catalogo.almacen');

    almacen = function () {
        idAlmacen = 0,
        ruta = '/CatAlmacen/FillGridAlmacen';
        estatus = {
            ACTIVO: '1',
            INACTIVO: '0'
        ...
        txtFiltroDireccion = $("#txtFiltroDireccion"),
        cboEstatus = $("#cboEstatus"),

        txtModalDireccion = $("#txtModalDireccion"),
        txtModalDescripcion = $("#txtModalDescripcion")

        btnBuscar = $("#btnBuscar_Almacen"),
        btnNuevo = $("#btnNuevo_Almacen"),
        btnGuardar = $("#btnModalGuardar_Almacen"),
        btnCancelar = $("#btnModalCancelar_Almacen"),
        modalAcciones = $("#modalAlmacen"),
        tituloModal = $("#title-modal"),
        gridResultado = $("#grid_Almacen");
        ...
        function init() {
            ...
            txtModalDireccion.addClass('required').attr('maxlength', 50);
        ...
        function openModal() {
            tituloModal.text("Alta Almacén");
            reset();
            cboModalEstatus.prop('disabled', true);
            modalAcciones.modal('show');
        }
        function update() {
            tituloModal.text("Actualizar Almacén");
        ...
        function getFiltrosObject() {
            return {
                almacen: "",//txtFiltroCentroCostos.val(),
                descripcion: txtFiltroDescripcion.val().trim(),
                direccion: txtFiltroDireccion.val()//,
    ...
    $(document).ready(function () {
        maquinaria.catalogo.almacen = new almacen();
    });
})();
