(function () {
    ...
    $.namespace('maquinaria.catalogo.centroCostos');

    centroCostos = function () {
        idCentroCostos = 0,
        ruta = '/CatObra/FillGridCentroCostos';
        estatus = {
            ACTIVO: '1',
            INACTIVO: '0'
        ...
        btnBuscar = $("#btnBuscar_CentroCostos"),
        btnNuevo = $("#btnNuevo_CentroCostos"),
        btnGuardar = $("#btnModalGuardar_CentroCostos"),
        btnCancelar = $("#btnModalCancelar_CentroCostos"),
        modalAcciones = $("#modalCentroCostos"),
        tituloModal = $("#title-modal"),
        gridResultado = $("#grid_CentroCostos");
        ...
        function openModal() {
            tituloModal.text("Alta Centro Costos");
            reset();
            cboModalEstatus.prop('disabled', true);
            modalAcciones.modal('show');
        }
        function update() {
            tituloModal.text("Actualizar Centro Costos");
    ...
    $(document).ready(function () {
        maquinaria.catalogo.centroCostos = new centroCostos();
    });
})();
