(function () {
    ...
    $.namespace('maquinaria.rentabilidad.corte');
    ...
    corte = function () {
        ...
        const getLstKubrix = new URL(window.location.origin + '/Rentabilidad/getLstKubrixCorteArrendadora');
        const getLstKubrixDetalle = new URL(window.location.origin + '/Rentabilidad/getLstKubrixCorteArrendadoraDetalle');
        ...
        //
        const conceptos = ["Ingresos Contabilizados", "<p class='guardarLinea' data-tipoGuardado='1'>Ingresos con Estimación</p>", "<p class='guardarLinea' data-tipoGuardado='2'>Ingresos Pendientes por Generar</p>",
    "Total Ingresos", "Costo Total", "Depreciación", "Utilidad Bruta", "Gastos de Operación", "Resultado Antes Finacieros",
    "Gastos y Productos Financieros", "Resultado con Financieros", "Otros Ingresos", "Resultado Neto", "% de Margen", "<p class='guardarLinea' data-tipoGuardado='3'>Costos Estimados</p>"];
        let divisiones = [];
        let areasCuenta = [];
        ...
        function agregarListeners()
        {
            ...
            $('#botonAtrasDetEco').click(function(){
                ...
                if($("#divTablaKubrixDivision").is(":visible")) {
                    $("#divTablaKubrixDivision").hide(500);
                    $("#divLblFiltrosDivision").hide(500);
                }
                if($("#contenedorDetalles").is(":visible")) {
                    $("#contenedorDetalles").hide(500);
                }
                if($("#divTablaKubrixDetalle").is(":visible")) {
                    $("#divTablaKubrixDetalle").hide(500);
                    $("#divLblFiltrosDetalle").hide(500);
                }
                if($("#divTablaKubrixDetalleEco").is(":visible")) { 
                    $("#divTablaKubrixDetalleEco").hide(500);
                    $("#divLblFiltrosDetalle").hide(500);
                }
                //$("#chbAgrupacionDet").hide(500);
                $("#divTablaKubrixAreaCuenta").show(500);
                $("#divLblFiltrosAC").show(500);
        ...
        function recargarFechasTipoRep() {
            ...
            let yearActual = inputCorte.datepicker('getDate').getFullYear();
                    ...
                    if (response.success) {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                if($("#divTablaKubrixAreaCuenta").is(":visible")) {
                                    $("#divTablaKubrixAreaCuenta").hide(500);
                                    $("#divLblFiltrosAC").hide(500);
                                }
                                if($("#contenedorDetalles").is(":visible")) {
                                    $("#contenedorDetalles").hide(500);
                                }
                                ...
                                $("#divLblFiltrosDivision").show(500);
                                //Cargar Costos Estimados
                                //var costosEst = $.grep(detallesRespuesta, function( n, i ) { return n.grupoInsumo == "1-4-0";  });
                                //cargarTablaCostosEstimados();
                            }
            ...
            $.post(getLstKubrixTablaDet, {
                ...
                .then(function(response) {
                    if (response.success) {
                        ...
                        detalles = $.grep(detalles, function( n, i ) { return n.grupoInsumo.indexOf("4000-9-") < 0;  });
        ...
        function setLstKubrixDetalle(tipo, columna, renglon, fecha, nombreRow, negativo, divisionCol, areaCuentaCol, economicoCol) {
            ...
            $.post(getLstKubrixDetalle, {
                ...
                columna: columna, 
                renglon: renglon,
                divisionTabla: divisionCol,
                areaCuentaTabla: areaCuentaCol,
                economicoTabla: economicoCol,
                acumulado: cbConfiguracion.val(),
                reporteCostos: false
            })
                .then(function(response) {
                    if (response.success) {
                        ...
                        detalles = $.grep(detalles, function( n, i ) { return n.cuenta.indexOf("4000-9-") < 0;  });
                        var sumadetalles = 0;
                        for(var i = 0; i < detalles.length; i++) { sumadetalles += detalles[i].monto; }
                        
                        cargarTablaSubCuenta(detalles, nombreRow, fecha, tipo == 3 ? columna : 1, negativo); 
        ...
        function setFormatoKubrixDetalles(e, datos) {
            ...
            if (botonBuscar.attr("data-tipoCorte") == 0 || botonBuscar.attr("data-tipoCorte") == 10) { initTablaKubrixDetalle(lst, 1); }
            ...
            if(!$("#contenedorDetalles").is(":visible")) {
                $("#contenedorDetalles").show(500);
            }
            $("#divTablaKubrixDetalle").show(500);
            $("#divLblFiltrosDetalle").show(500);
            //Cargar Costos Estimados
        ...
        function FormatoDetalles(source, separadores, tipo)
        {
            ...
            for(var i = 1; i <= 14; i++)
            {
                ...
                {
                    case 1:
                        detalles =  $.grep(source, function(el,index){ return (el.cuenta.indexOf("4000-") >= 0 && el.cuenta.indexOf("4000-8-") < 0 && el.cuenta.indexOf("4000-9-") < 0 && el.cuenta.indexOf("4000-9-") < 0 && el != null); }); 
                        var totalImporte = 0;
            ...
            dtTablaKubrixDetalle = tablaKubrixDetalle.DataTable({
                ...
                drawCallback: function( settings ) {    
                    ...
                    $("#divLblFiltrosDetalle")
                        .html(
                            '<div class="col-xs-12 col-sm-12 col-md-1 col-lg-1">'+
                                '<button class="btn btn-warning btn-atras" id="botonAtrasDetalle"> <i class="fas fa-level-up-alt"></i></button>'+
                            '</div>'+
                            '<div class="col-xs-12 col-sm-12 col-md-11 col-lg-11">'+
                                '<div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 no-padding header-border">'+
                                    '<b>División:</b><br/> ' + (stringDivision == "TODAS" ? $("#comboDivision option:selected").text().trim() : stringDivision) +
                                '</div>'+
                                '<div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 no-padding header-border">'+
                                    '<b>Area Cuenta:</b><br/> ' + (stringAreaCuenta == "TODAS" ? ($("#comboAC option:selected").text().trim() == "" ? "TODAS" : $("#comboAC option:selected").toArray().map(function(item) { return item.text; }).join(", ")) : stringAreaCuenta) +
                                '</div>'+
                                '<div class="col-xs-12 col-sm-12 col-md-1 col-lg-1 no-padding header-border">'+
                                    '<b>Ejercicio:</b><br/> ' + $("#cbConfiguracion option:selected").text().trim() +
                                '</div>'+                                    
                                '<div class="col-xs-12 col-sm-12 col-md-1 col-lg-1 no-padding header-border">'+
                                    '<b>Corte a:</b><br/> ' + inputCorte.val().trim() +
                                '</div>'+                                    
                                '<div class="col-xs-12 col-sm-12 col-md-1 col-lg-1 no-padding header-border">'+
                                    (cboMaquina.val() == "" ? '' : '<b>Economico:</b><br/> ' + $("#cboMaquina option:selected").text().trim()) +
                                '</div>' +
                            '</div>');
                    ...
                    $(".filtrado").click(function (e) {   
                        ...
                        var detallesRaw = rowData.map(function(x) { return x.detalles != null ?  x.detalles : [] });
                        var detalles = [].concat.apply([], detallesRaw); 
                        if (dtTablaKubrixDetalle.data().any()) {
                            ...
                            switch (idTipo) {
                                case "1":
                                    ...
                                    detalles = jQuery.grep(detalles, function( n, i ) { return n != null && n.tipoEquipo == 1; });
                                    info = obtenerListaAnalisis(detalles, idTipo);
                                    cargarDatosTablaAnalisis(info, 1, 1);                                    
                                    break;
                                case "2":
                                    $("#tituloModal").text("ARRENDADORA - EQUIPO MENOR");
                                    detalles = jQuery.grep(detalles, function( n, i ) { return n != null && n.tipoEquipo == 2; });
                                    info = obtenerListaAnalisis(detalles, idTipo);
                                    cargarDatosTablaAnalisis(info, 0, 0);
                                    break;
                                case "3":
                                    $("#tituloModal").text("ARRENDADORA - EQUIPO TRANSPORTE CONSTRUPLAN");
                                    detalles = jQuery.grep(detalles, function( n, i ) { return n != null && n.tipoEquipo == 3; });
                                    info = obtenerListaAnalisis(detalles, idTipo);
                                    cargarDatosTablaAnalisis(info, 0, 0);
                                    break;
                                case "4":
                                    $("#tituloModal").text("ARRENDADORA - FLETES");
                                    detalles = jQuery.grep(detalles, function( n, i ) { return n != null && n.tipoEquipo == 4; });
                                    info = obtenerListaAnalisis(detalles, idTipo);
                                    cargarDatosTablaAnalisis(info, 0, 0);
                                    break;
                                case "5":
                                    $("#tituloModal").text("ARRENDADORA - OTR");
                                    detalles = jQuery.grep(detalles, function( n, i ) { return n != null && n.tipoEquipo == 5; });
                                    info = obtenerListaAnalisis(detalles, idTipo);
                                    cargarDatosTablaAnalisis(info, 0, 0);
                                    break;
                                case "6":
                                    $("#tituloModal").text("ARRENDADORA - ADMINISTRATIVO CENTRAL");
                                    detalles = jQuery.grep(detalles, function( n, i ) { return n != null && n.tipoEquipo == 6; });
                                    info = obtenerListaAnalisis(detalles, idTipo);
                                    cargarDatosTablaAnalisis(info, 0, 0);
                                    break;
                                case "7":
                                    $("#tituloModal").text("ARRENDADORA - OTROS");
                                    detalles = jQuery.grep(detalles, function( n, i ) { return n != null && n.tipoEquipo == 7; });
                                    info = obtenerListaAnalisis(detalles, idTipo);
                                    cargarDatosTablaAnalisis(info, 0, 0);
                                    break;
                                case "8":
                                    $("#tituloModal").text("ARRENDADORA - EQUIPO TRANSPORTE ARRENDADORA");
                                    detalles = jQuery.grep(detalles, function( n, i ) { return n != null && n.tipoEquipo == 8; });
                                    info = obtenerListaAnalisis(detalles, idTipo);
                                    cargarDatosTablaAnalisis(info, 0, 0);
                                    break;
                                case "9":
                                    $("#tituloModal").text("ARRENDADORA - ADMINISTRATIVO PROYECTOS");
                                    detalles = jQuery.grep(detalles, function( n, i ) { return n != null && n.tipoEquipo == 9; });
                                    info = obtenerListaAnalisis(detalles, idTipo);
                                    cargarDatosTablaAnalisis(info, 0, 0);
                                    break;
                                default:
                ...
                drawCallback: function( settings ) {
                    ...
                    $("#divLblFiltrosDetalleEco")
                        .html(
                            ...
                            '<div class="col-xs-12 col-sm-12 col-md-11 col-lg-11">'+
                                ...
                                '</div>' +
                            '</div>');
                        //        '<b>TABLA DETALLE</b>&nbsp;&nbsp;>>>>&nbsp;&nbsp;<b>División:</b> ' + (stringDivision == "TODAS" ? $("#comboDivision option:selected").text().trim() : stringDivision) + 
                    ...
                    tablaKubrixDetalleEco.find('p.desplegable').unbind().click(function (e) {
                        ...
                        if(tablaResumida)
                        {
                            ...
                            {
                                case 1:
                                    detalles = jQuery.grep(detalles, function( el, i ) { return ((el.cuenta.indexOf("4000-") >= 0 && el.cuenta.indexOf("4000-9-") < 0) || el.cuenta.indexOf("4900-") >= 0 || el.cuenta.indexOf("4901-") >= 0 
                        ...
                        else
                        {
                            ...
                            {
                                case 1:
                                    detalles = jQuery.grep(detalles, function( el, i ) { return el.cuenta.indexOf("4000-") >= 0 && el.cuenta.indexOf("4000-8-") < 0  && el.cuenta.indexOf("4000-9-") < 0; });
                                    break;
                                case 2:
                        ...
                        setLstKubrixDetalle(tablaResumida ? 6 : 5, (indexCol - 1), 0, auxFecha, rowData.descripcion, negativo, divisionFiltroDetalle, areaCuentaFiltroDetalle, rowData.descripcion);
                        columnaGlobal = 0;                        
        ...
        function getColumnasDetalleEco()
        {
            ...
            else
            {
                return[
                    ...
                    { data: 'gastosProductosFinancieros', title: '<span class="tituloKubrixEc">Gastos y Productos Financieros</span>', render: function (data, type, row) { return getRowHTML(data); } },
                    { data: 'resultadoFinancieros', title: '<span class="tituloKubrixEc">Resultado con Financieros</span>', render: function (data, type, row) { return getNumberHTML(data); } },
        ...
        function initTablaKubrixDivision(data, separador, nombreTotal) {
            ...
            dtTablaKubrixDivision = tablaKubrixDivision.DataTable({
                ...
                createdRow: function( row, data, dataIndex){
                    if( dataIndex == 3 || dataIndex == 7 || dataIndex == 9 || dataIndex == 11 || dataIndex == 13 ||  dataIndex == 14){
                        $(row).addClass('resultado');
                    }
                },
            ...
            dtTablaKubrixAreaCuenta = tablaKubrixAreaCuenta.DataTable({
                ...
                drawCallback: function( settings ) {     
                    ...
                    $("#divLblFiltrosAC")
                        .html(
                            '<div class="col-xs-12 col-sm-12 col-md-1 col-lg-1">'+
                                '<button class="btn btn-warning btn-atras" id="botonAtrasAC"> <i class="fas fa-level-up-alt"></i></button>'+
                            '</div>'+
                            '<div class="col-xs-12 col-sm-12 col-md-11 col-lg-11">'+
                                '<div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 no-padding header-border">'+
                                    '<b>División:</b><br/> ' + (stringDivision == "TODAS" ? $("#comboDivision option:selected").text().trim() : stringDivision) +
                ...
                createdRow: function( row, data, dataIndex){
                    if( dataIndex == 3 || dataIndex == 7 || dataIndex == 9 || dataIndex == 11 || dataIndex == 12 ||  dataIndex == 14){
                        $(row).addClass('resultado');
                    }
                },
            });
        ...
        function AsignarImportesAnalisis(importes, fecha)
        {
            ...
            //80-20
            var cfc = jQuery.grep(importes, function( n, i ) { return n.cc.indexOf("CFC-") >= 0  && n.semana == 1 /* && new Date(parseInt(n.fecha.substr(6))) <= fecha*/; }); 
            if (cfc.length > 0) { for(var i = 0; i < cfc.length; i++) { costos.cfc += cfc[i].monto; } }
            var cf = jQuery.grep(importes, function( n, i ) { return n.cc.indexOf("CF-") >= 0 && (n.semana == 1 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false )); });            
            if (cf.length > 0) { for(var i = 0; i < cf.length; i++) { costos.cf += cf[i].monto; } }
            var mc = jQuery.grep(importes, function( n, i ) { return n.cc.indexOf("MC-") >= 0 && (n.semana == 1 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false )); });            
            if (mc.length > 0) { for(var i = 0; i < mc.length; i++) { costos.mc += mc[i].monto; } }
            var pr = jQuery.grep(importes, function( n, i ) { return n.cc.indexOf("PR-") >= 0 && (n.semana == 1 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false )); });            
            if (pr.length > 0) { for(var i = 0; i < pr.length; i++) { costos.pr += pr[i].monto; } }
            var tc = jQuery.grep(importes, function( n, i ) { return n.cc.indexOf("TC-") >= 0 && (n.semana == 1 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false )); });            
            if (tc.length > 0) { for(var i = 0; i < tc.length; i++) { costos.tc += tc[i].monto; } }
            var car = jQuery.grep(importes, function( n, i ) { return n.cc.indexOf("CAR-") >= 0 && (n.semana == 1 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false )); });            
            if (car.length > 0) { for(var i = 0; i < car.length; i++) { costos.car += car[i].monto; } }
            var ex = jQuery.grep(importes, function( n, i ) { return n.cc.indexOf("EX-") >= 0 && (n.semana == 1 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false )); }); 
            if (ex.length > 0) { for(var i = 0; i < ex.length; i++) { costos.ex += ex[i].monto; } }
            var hdt = jQuery.grep(importes, function( n, i ) { return n.cc.indexOf("HDT-") >= 0 && (n.semana == 1 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false )); }); 
            if (hdt.length > 0) { for(var i = 0; i < hdt.length; i++) { costos.dt += hdt[i].monto; } }
            var otros = jQuery.grep(importes, function( n, i ) { return n.cc.indexOf("CFC-") == -1 && n.cc.indexOf("CF-") == -1 && n.cc.indexOf("MC-") == -1 && n.cc.indexOf("PR-") == -1 && 
                n.cc.indexOf("TC-") == -1 && n.cc.indexOf("CAR-") == -1 && n.cc.indexOf("EX-") == -1 && n.cc.indexOf("HDT-") == -1 && (n.semana == 1 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false )); });            
            if (otros.length > 0) { for(var i = 0; i < otros.length; i++) { costos.otros += otros[i].monto; } }
            //Semanal
            var auxFechaAnalisis = new Date(fecha);
            var actual = jQuery.grep(importes, function( n, i ) { return (n.semana == 1 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false )); });
            if (actual.length > 0) { for(var i = 0; i < actual.length; i++) { costos.actual += actual[i].monto; } }
            auxFechaAnalisis.setDate(auxFechaAnalisis.getDate() - 7);
            var semana2 = jQuery.grep(importes, function( n, i ) { return  (n.semana == 2 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false )); });            
            if (semana2.length > 0) { for(var i = 0; i < semana2.length; i++) { costos.semana2 += semana2[i].monto; } }
            auxFechaAnalisis.setDate(auxFechaAnalisis.getDate() - 7);
            var semana3 = jQuery.grep(importes, function( n, i ) { return (n.semana == 3 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false )); });            
            if (semana3.length > 0) { for(var i = 0; i < semana3.length; i++) { costos.semana3 += semana3[i].monto; } }
            auxFechaAnalisis.setDate(auxFechaAnalisis.getDate() - 7);
            var semana4 = jQuery.grep(importes, function( n, i ) { return (n.semana == 4 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false )); });            
            if (semana4.length > 0) { for(var i = 0; i < semana4.length; i++) { costos.semana4 += semana4[i].monto; } }
            auxFechaAnalisis.setDate(auxFechaAnalisis.getDate() - 7);
            var semana5 = jQuery.grep(importes, function( n, i ) { return (n.semana == 5 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false )); });            
            if (semana5.length > 0) { for(var i = 0; i < semana5.length; i++) { costos.semana5 += semana5[i].monto; } }
            return costos;
            ...
            $.each(separador, function (key, value){
                var auxColumna = {
                    ...
                    render: function (data, type, row, meta) {
                        ...
                        if (index == 4 || index == 8 || index == 10 || index == 12 || index == 14)
        ...
        function cargarTablaSubSubCuenta(detalles, nombreColumna, total, fecha, tipo, semanal) {
            ...
            if(detalles.length > 0){
                ...
                Array.from(grouped, function ([key, value]) {
                    var auxCuenta = value[0].cuenta.split('-');
                    var auxDescripcion = cuentasDescr.find(x => x.Value === value[0].cuenta);
                    const cta = parseInt(auxCuenta[0]);
                    const scta = parseInt(auxCuenta[1]);
                    const sscta = parseInt(auxCuenta[2]);
                    const id = value[0].cuenta;
                    const descripcion = auxDescripcion == null ? value[0].cuenta : cuentasDescr.find(x => x.Value === value[0].cuenta).Text;
                    const importeDetalles = $.grep(value, function(n, i){ return (n.semana == numSemana || (cbConfiguracion.val() == '0' ? n.semana == 6 : false )) && n.tipoMov < 2; }).map(function(x) { return x.monto; });
                    var importeDetallesSemanal = $.grep(value, function(n, i){ return (n.semana == numSemana || (cbConfiguracion.val() == '0' ? n.semana == 6 : false )) && n.tipoMov === 1; }).map(function(x) { return x.monto; });
                    const importeDetallesCancelados = $.grep(value, function(n, i){ return (n.semana == numSemana || (cbConfiguracion.val() == '0' ? n.semana == 6 : false )) && n.tipoMov === 2; }).map(function(x) { return x.monto; });
                    importeDetallesSemanal = $.merge(importeDetallesSemanal, importeDetallesCancelados);
        ...
        function cargarSubCuenta(detalles, nombreColumna, total, columna, tipo, fecha) {
            ...
            if(tipo == 1) {         
                ...
                switch (columna) {
                    case 1: // Total
                        detallesFiltrados = jQuery.grep(detalles, function( n, i ) {
                            return (n.semana == 1 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false ));
                        });
                        $("#tituloSctaDetalles").text("Total");
                        break;
                    case 2: // CFC
                        detallesFiltrados = jQuery.grep(detalles, function( n, i ) {
                            return n.noEco.indexOf("CFC-") >= 0 && new (n.semana == 1 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false ));
                        });
                        $("#tituloSctaDetalles").text("CFC");
                        break;
                    case 3: // CF
                        detallesFiltrados = jQuery.grep(detalles, function( n, i ) {
                            return n.noEco.indexOf("CF-") >= 0 && (n.semana == 1 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false ));
                        });
                        $("#tituloSctaDetalles").text("CF");
                        break;
                    case 4: // MC
                        detallesFiltrados = jQuery.grep(detalles, function( n, i ) {
                            return n.noEco.indexOf("MC-") >= 0 && (n.semana == 1 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false ));
                        });
                        $("#tituloSctaDetalles").text("MC");
                        break;
                    case 5: // PR
                        detallesFiltrados = jQuery.grep(detalles, function( n, i ) {
                            return n.noEco.indexOf("PR-") >= 0 && (n.semana == 1 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false ));
                        });
                        $("#tituloSctaDetalles").text("PR");
                        break;
                    case 6: // TC
                        detallesFiltrados = jQuery.grep(detalles, function( n, i ) {
                            return n.noEco.indexOf("TC-") >= 0 && (n.semana == 1 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false ));
                        });
                        $("#tituloSctaDetalles").text("TC");
                        break;
                    case 7: // CAR
                        detallesFiltrados = jQuery.grep(detalles, function( n, i ) {
                            return n.noEco.indexOf("CAR-") >= 0 && (n.semana == 1 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false ));
                        });
                        $("#tituloSctaDetalles").text("CAR");
                        break;
                    case 8: // EX
                        detallesFiltrados = jQuery.grep(detalles, function( n, i ) {
                            return n.noEco.indexOf("EX-") >= 0 && (n.semana == 1 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false ));
                        });
                        $("#tituloSctaDetalles").text("EX");
                        break;
                    case 9: // HDT
                        detallesFiltrados = jQuery.grep(detalles, function( n, i ) {
                            return n.noEco.indexOf("HDT-") >= 0 && (n.semana == 1 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false ));
                        });
                    ...
                    case 10: // OTROS
                        detallesFiltrados = jQuery.grep(detalles, function( n, i ) {
                            return n.noEco.indexOf("CFC-") == -1 && n.noEco.indexOf("CF-") == -1 && n.noEco.indexOf("MC-") == -1 && n.noEco.indexOf("PR-") == -1 
                                && n.noEco.indexOf("TC-") == -1 && n.noEco.indexOf("CAR-") == -1 && n.noEco.indexOf("EX-") == -1 && n.noEco.indexOf("HDT-") == -1 && (n.semana == 1 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false ));
                        });
                ...
                detallesFiltrados = jQuery.grep(detalles, function( n, i ) {
                    return (n.semana == columna || (cbConfiguracion.val() == '0' ? n.semana == 6 : false ));
                });
                const totalDetalle = detallesFiltrados.length > 0 ? detallesFiltrados.map(function(x) { return x.monto; }).reduce(function(total, importe) { return total + importe; }) : 0;      
                dtTablaSctaDetalles.clear();
                Array.from(grouped, function([key, value])  {                    
                    ...
                    const grafica = '<button class="btn btn-sm btn-primary grafica"><i class="fas fa-chart-line"></i></button>';
                    const descripcion = key;
                    const importe = detallesFiltradosSemanal.length > 0 ? detallesFiltradosSemanal.map(function(x) { return x.monto; }).reduce(function(total, importe) { return total + importe; }) : 0;
                    const acumulado = detallesFiltrados.length > 0 ? detallesFiltrados.map(function(x) { return x.monto; }).reduce(function(total, importe) { return total + importe; }) : 0;
                    const porcentajeNum = (importe / totalDetalle) * 100
                    const grupo = { cta: cta, scta: scta, id: id, grafica: grafica, descripcion: descripcion, importe: monto, detalles: detallesFiltrados, acumulado: acumulado, porcentaje: porcentajeNum, fecha: dateMax, tipo: tipo/*, detallesSemanal: detallesFiltradosSemanal*/ };
                    dtTablaSctaDetalles.row.add(grupo);
                });
            }
            dtTablaSctaDetalles.draw();
        ...
        function obtenerListaKubrixEconomico(listaRentabilidad, busq)
        {
            ...
            listaRentabilidad1 = $.grep(listaRentabilidad,function(el,index){ return el.cuenta.indexOf("4000-") >= 0 && el.cuenta.indexOf("4000-8-") < 0 && el.cuenta.indexOf("4000-9-") < 0 && (el.semana == 1 || (cbConfiguracion.val() == '0' ? el.semana == 6 : false )) && el.tipoMov < 2; });
            listaRentabilidad2 = $.grep(listaRentabilidad,function(el,index){ return (el.cuenta == "1-1-0" || el.cuenta == "1-3-1" || el.cuenta == "1-3-2") && (el.semana == 1 || (cbConfiguracion.val() == '0' ? el.semana == 6 : false )) && el.tipoMov < 2; });
            listaRentabilidad3 = $.grep(listaRentabilidad,function(el,index){ return (el.cuenta == "1-2-1" || el.cuenta == "1-2-2" || el.cuenta == "1-2-3") && (el.semana == 1 || (cbConfiguracion.val() == '0' ? el.semana == 6 : false )) && el.tipoMov < 2; });
            listaRentabilidad4 = $.grep(listaRentabilidad,function(el,index){ return el.cuenta.indexOf("5000-") >= 0 && el.cuenta.indexOf("5000-10-") < 0 && (el.semana == 1 || (cbConfiguracion.val() == '0' ? el.semana == 6 : false )) && el.tipoMov < 2; });
            listaRentabilidad5 = $.grep(listaRentabilidad,function(el,index){ return el.cuenta.indexOf("5000-10") >= 0 && (el.semana == 1 || (cbConfiguracion.val() == '0' ? el.semana == 6 : false )) && el.tipoMov < 2; });
            listaRentabilidad6 = $.grep(listaRentabilidad,function(el,index){ return el.cuenta == "1-4-0" && (el.semana == 1 || (cbConfiguracion.val() == '0' ? el.semana == 6 : false )) && el.tipoMov < 2; });
            listaRentabilidad7 = $.grep(listaRentabilidad,function(el,index){ return el.cuenta.indexOf("5280-") >= 0 && (el.semana == 1 || (cbConfiguracion.val() == '0' ? el.semana == 6 : false )) && el.tipoMov < 2; });
            listaRentabilidad8 = $.grep(listaRentabilidad,function(el,index){ return (el.cuenta.indexOf("4900-") >= 0 || el.cuenta.indexOf("5900-") >= 0) && (el.semana == 1 || (cbConfiguracion.val() == '0' ? el.semana == 6 : false )) && el.tipoMov < 2; });
            listaRentabilidad9 = $.grep(listaRentabilidad,function(el,index){ return (el.cuenta.indexOf("4901-") >= 0 || el.cuenta.indexOf("4000-8-") >= 0 || el.cuenta.indexOf("5901-") >= 0) && (el.semana == 1 || (cbConfiguracion.val() == '0' ? el.semana == 6 : false )) && el.tipoMov < 2; });
        ...
        function obtenerListaKubrixEcoCompacto(listaRentabilidad, busq)
        {
            var listaUtilidad = [];
            listaRentabilidad = $.grep(listaRentabilidad,function(el,index){ return el != null; });
            listaRentabilidadIngresos = $.grep(listaRentabilidad,function(el,index){ return ((el.cuenta.indexOf("4000-") >= 0 && el.cuenta.indexOf("4000-9-") < 0) || el.cuenta.indexOf("4900-") >= 0 || el.cuenta.indexOf("4901-") >= 0 
                    || el.cuenta == "1-1-0" || el.cuenta == "1-2-1" || el.cuenta == "1-2-2" || el.cuenta == "1-2-3" || el.cuenta == "1-3-1" || el.cuenta == "1-3-2") && (el.semana == 1 || (cbConfiguracion.val() == '0' ? el.semana == 6 : false )) && el.tipoMov < 2; });
        ...
        function obtenerListaKubrix(listaRentabilidad, busq)
        {
            ...
            var elemento = $.grep(listaRentabilidad,function(el,index){ return el.cuenta.indexOf("4000-") >= 0 && el.cuenta.indexOf("4000-8-") < 0 && el.cuenta.indexOf("4000-9-") < 0 ; });
            ...
            utilidad = AsignarImportesKubrix(elemento, busq.fechaFin, "<p class='guardarLinea' data-tipoGuardado='3'>Costo Estimado</p>", 15, true);
            listaUtilidad.push(utilidad);
            //--Utilidad Bruta--//           
            utilidad = 
            {
                ...
                mayor: $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 4; })[0].mayor - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 5; })[0].mayor - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 6; })[0].mayor - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 15; })[0].mayor,
                menor: $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 4; })[0].menor - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 5; })[0].menor - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 6; })[0].menor - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 15; })[0].menor,
                transporteConstruplan: $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 4; })[0].transporteConstruplan - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 5; })[0].transporteConstruplan - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 6; })[0].transporteConstruplan - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 15; })[0].transporteConstruplan,
                transporteArrendadora: $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 4; })[0].transporteArrendadora - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 5; })[0].transporteArrendadora - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 6; })[0].transporteArrendadora - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 15; })[0].transporteArrendadora,
                administrativoCentral: $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 4; })[0].administrativoCentral - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 5; })[0].administrativoCentral - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 6; })[0].administrativoCentral - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 15; })[0].administrativoCentral,
                administrativoProyectos: $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 4; })[0].administrativoProyectos - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 5; })[0].administrativoProyectos - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 6; })[0].administrativoProyectos - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 15; })[0].administrativoProyectos,
                fletes: $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 4; })[0].fletes - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 5; })[0].fletes - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 6; })[0].fletes - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 15; })[0].fletes,
                neumaticos: $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 4; })[0].neumaticos - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 5; })[0].neumaticos - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 6; })[0].neumaticos - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 15; })[0].neumaticos,
                otros: $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 4; })[0].otros - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 5; })[0].otros - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 6; })[0].otros - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 15; })[0].otros,
                total: $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 4; })[0].total - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 5; })[0].total - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 6; })[0].total - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 15; })[0].total,
                actual: $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 4; })[0].actual - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 5; })[0].actual - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 6; })[0].actual - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 15; })[0].actual,
                semana2: $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 4; })[0].semana2 - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 5; })[0].semana2 - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 6; })[0].semana2 - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 15; })[0].semana2,
                semana3: $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 4; })[0].semana3 - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 5; })[0].semana3 - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 6; })[0].semana3 - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 15; })[0].semana3,
                semana4: $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 4; })[0].semana4 - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 5; })[0].semana4 - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 6; })[0].semana4 - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 15; })[0].semana4,
                semana5: $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 4; })[0].semana5 - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 5; })[0].semana5 - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 6; })[0].semana5 - $.grep(listaUtilidad, function(el,index){ return el.tipo_mov == 15; })[0].semana5,
            };
            listaUtilidad.push(utilidad);
            //--Gastos de Operación--//
            elemento = $.grep(listaRentabilidad,function(el,index){ return el.cuenta.indexOf("5280-") >= 0; });
            utilidad = AsignarImportesKubrix(elemento, busq.fechaFin, "Gastos de Operación", 8, true);
            listaUtilidad.push(utilidad);
            ...
            elemento = $.grep(listaRentabilidad,function(el,index){ return (el.cuenta.indexOf("4900-") >= 0 || el.cuenta.indexOf("5900-") >= 0); });
            utilidad = AsignarImportesKubrix(elemento, busq.fechaFin, "Gastos y Productos Financieros", 10, false);
            listaUtilidad.push(utilidad);
            ...
            utilidad = AsignarImportesKubrix(elemento, busq.fechaFin, "Otros Ingresos", 12, false);
            listaUtilidad.push(utilidad);
            //--Resultado Neto--//           
            utilidad =
            {
        ...
        function AsignarImportesKubrix(importes, fecha, descripcion, tipoMov, negativo)
        {
            ...
            var mayor = $.grep(auxImportes,function(el,index){ return el.tipoEquipo == 1 && (el.semana == 1 || (cbConfiguracion.val() == '0' ? el.semana == 6 : false )); });
            if (mayor.length > 0) { $.each(mayor, function(index, element){ costo.mayor += (element.monto * (negativo ? (-1) : 1)) || 0; }); }
            var menor = $.grep(auxImportes,function(el,index){ return el.tipoEquipo == 2 && (el.semana == 1 || (cbConfiguracion.val() == '0' ? el.semana == 6 : false )); });
            if (menor.length > 0) { $.each(menor, function(index, element){ costo.menor += (element.monto * (negativo ? (-1) : 1)) || 0; }); }
            var transporteConstruplan = $.grep(auxImportes,function(el,index){ return el.tipoEquipo == 3 && (el.semana == 1 || (cbConfiguracion.val() == '0' ? el.semana == 6 : false )); });
            ...
            var transporteArrendadora = $.grep(auxImportes,function(el,index){ return el.tipoEquipo == 8 && (el.semana == 1 || (cbConfiguracion.val() == '0' ? el.semana == 6 : false )); });
            ...
            var administrativoCentral = $.grep(auxImportes,function(el,index){ return el.tipoEquipo == 6 && (el.semana == 1 || (cbConfiguracion.val() == '0' ? el.semana == 6 : false )); });
            ...
            var administrativoProyectos = $.grep(auxImportes,function(el,index){ return el.tipoEquipo == 9 && (el.semana == 1 || (cbConfiguracion.val() == '0' ? el.semana == 6 : false )); });
            ...
            var fletes = $.grep(auxImportes,function(el,index){ return el.tipoEquipo == 4 && (el.semana == 1 || (cbConfiguracion.val() == '0' ? el.semana == 6 : false )); });
            if (fletes.length > 0) { $.each(fletes, function(index, element){ costo.fletes += (element.monto * (negativo ? (-1) : 1)) || 0; }); }
            var neumaticos = $.grep(auxImportes,function(el,index){ return el.tipoEquipo == 5 && (el.semana == 1 || (cbConfiguracion.val() == '0' ? el.semana == 6 : false )); });
            if (neumaticos.length > 0) { $.each(neumaticos, function(index, element){ costo.neumaticos += (element.monto * (negativo ? (-1) : 1)) || 0; }); }
            var otros = $.grep(auxImportes,function(el,index){ return el.tipoEquipo == 7 && (el.semana == 1 || (cbConfiguracion.val() == '0' ? el.semana == 6 : false )); });
            if (otros.length > 0) { $.each(otros, function(index, element){ costo.otros += (element.monto * (negativo ? (-1) : 1)) || 0; }); }
            var total = $.grep(auxImportes,function(el,index){ return (el.semana == 1 || (cbConfiguracion.val() == '0' ? el.semana == 6 : false )); });
            if (total.length > 0) { $.each(total, function(index, element){ costo.total += (element.monto * (negativo ? (-1) : 1)) || 0; }); }
                    
            //Semanal
            var auxFecha = new Date(fecha);
            var actual = jQuery.grep(auxImportes, function( n, i ) { return (n.semana == 1 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false )); });
            if (actual.length > 0) { $.each(actual, function(index, element){ costo.actual += (element.monto * (negativo ? (-1) : 1)) || 0; });}
            var semana2 = jQuery.grep(auxImportes, function( n, i ) { return (n.semana == 2 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false )) });
            if (semana2.length > 0) { $.each(semana2, function(index, element){ costo.semana2 += (element.monto * (negativo ? (-1) : 1)) || 0; });}
            var semana3 = jQuery.grep(auxImportes, function( n, i ) { return (n.semana == 3 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false )) });
            if (semana3.length > 0) { $.each(semana3, function(index, element){ costo.semana3 += (element.monto * (negativo ? (-1) : 1)) || 0; });}
            var semana4 = jQuery.grep(auxImportes, function( n, i ) { return (n.semana == 4 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false )) });
            if (semana4.length > 0) { $.each(semana4, function(index, element){ costo.semana4 += (element.monto * (negativo ? (-1) : 1)) || 0; });}
            var semana5 = jQuery.grep(auxImportes, function( n, i ) { return (n.semana == 5 || (cbConfiguracion.val() == '0' ? n.semana == 6 : false )) });
        ...
        {
            if(usuarioID == 1176 || usuarioID == 6032 || usuarioID == 3841 || usuarioID == 6137 || usuarioID == 6494){
                switch(tipoGuardado)
                {
                    case "1":
    ...
    $(document).ready(function () {
        maquinaria.rentabilidad.corte = new corte();
