(function () {
    ...
    $.namespace('Maquinaria.Rentabilidad.GuardarCorteArrendadoraKubrix');

    GuardarCorteArrendadoraKubrix = function () {
        ...
        function CargarTablaBalanza() {
            $.post(CargarBalanza, { tipo: cboTipoCorte.val(), empresa: 2 })
        ...
        function setGuardarCorte(e) {
            ...
            e.stopPropagation();
            e.stopImmediatePropagation();
            $.post(GuardarCorte, { tipo: tipoCorte, empresa: 2 })
                .then(function (response) {
                    if (response.success) {
                        // Operación exitosa.
        ...
        function enviarCorreoSemanal() {
            $.post(EnviarCorreoSemanal, { tipo: tipoCorte, empresa: 2 })
                .then(function (response) {
                    if (response.success) {
                        // Operación exitosa.
                        $("#modalConfirmacionCorte").modal("hide");
    ...
    $(document).ready(function () {
        Maquinaria.Rentabilidad.GuardarCorteArrendadoraKubrix = new GuardarCorteArrendadoraKubrix();
