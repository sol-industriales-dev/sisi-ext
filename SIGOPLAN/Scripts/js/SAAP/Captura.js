(() => {
    ...
    Captura = function () {
        ...
        function guardarEvidencia() {
            ...
            $.ajax({
                url: '/SAAP/SAAP/GuardarEvidencia',
                data: data,
                async: false,
                cache: false,
                contentType: false,
        ...
        function initTablaCapturas() {
            dtCapturas = tablaCapturas.DataTable({
                ...
                columns: [
                    ...
                    //     }
                    // },
                    { data: 'estatusEvidenciaDesc', title: 'Estatus' },
                    { data: 'fechaCompromisoString', title: 'Fecha Compromiso' },
                    {
                        data: 'progresoEstimado', title: 'Autoevaluación', render: function (data, type, row, meta) {
                            return `
        ...
        function cargarAsignacionCaptura() {
            axios.post('/SAAP/SAAP/GetAsignacionActividadesCaptura', { agrupacion_id: +selectCentroCosto.getAgrupador(), area: +selectArea.val(), estatus: +selectEstatus.val() })
                .then(response => {
                    let { success, datos, message } = response.data;
    ...
    $(document).ready(() => SAAP.SAAP.Captura = new Captura())
