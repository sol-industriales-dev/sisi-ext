        ...
        public IActionResult OpenDocument(string fileName)
        {
            ...
            if (string.IsNullOrEmpty(token))
            {
                ...
                try
                {
                    ...
                    // Get Cloud Config
                    CloudUploadConfig cloudConfig = GetUploadConfig(CloudLocation.AmazonS3); // Pass your preferred provider.
        ...
        private CloudUploadConfig GetUploadConfig(CloudLocation cloudLocation)
        {
            ...
            switch (cloudLocation)
            {
                ...
                case CloudLocation.AmazonS3:
                    ...
                    {
                        DoconutAwsS3BucketName = _configuration.GetSection("DoconutAwsS3BucketName").Value,
                        DoconutAwsS3RegionEndpoint = _configuration.GetSection("AWS:Region").Value,
                        DoconutAwsS3Key = _configuration.GetSection("DoconutAwsS3Access:DoconutAwsS3Key").Value,
                        DoconutAwsS3Secret = _configuration.GetSection("DoconutAwsS3Access:DoconutAwsS3Secret").Value
                    };
                    break;
