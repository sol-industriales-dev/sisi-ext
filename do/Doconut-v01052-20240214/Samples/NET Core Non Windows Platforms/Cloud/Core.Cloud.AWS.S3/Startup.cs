...
namespace Doconut.Mvc.Core
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            string region = Configuration.GetSection("AWS:Region").Value;
            string bucketName = Configuration.GetSection("DoconutAwsS3BucketName").Value;
            string awsS3Key = Configuration.GetSection("DoconutAwsS3Access:DoconutAwsS3Key").Value;
            string awsS3Secret = Configuration.GetSection("DoconutAwsS3Access:DoconutAwsS3Secret").Value;
            ...
            app.MapWhen(
              ...
              appBranch =>
              {
                  var cloudOptions = new Cloud.CloudOptions
                  {
                      ...
                      PngPath = Path.Combine(env.WebRootPath, "webfarm"),
                      ...
                      {
                          DoconutAwsS3BucketName = bucketName,
                          DoconutAwsS3Key = awsS3Key,
                          DoconutAwsS3Secret = awsS3Secret,
                          DoconutAwsS3RegionEndpoint = region,
