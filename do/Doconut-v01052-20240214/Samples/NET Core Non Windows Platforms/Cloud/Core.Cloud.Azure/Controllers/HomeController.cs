        ...
        public IActionResult OpenDocument(string fileName)
        {
            ...
            if (string.IsNullOrEmpty(token))
            {
                ...
                try
                {
                    ...
                    // Get Cloud Config
                    CloudUploadConfig cloudConfig = GetUploadConfig(CloudLocation.Azure); // Pass your preferred provider.
        ...
        private CloudUploadConfig GetUploadConfig(CloudLocation cloudLocation)
        {
            ...
            switch (cloudLocation)
            {
                case CloudLocation.Azure:
                    ...
                    {
                        DoconutAzureContainerName = _configuration.GetSection("DoconutAzureAccess:DoconutAzureContainerName").Value,
                        DoconutAzureStorageConnectionString = _configuration.GetSection("DoconutAzureAccess:DoconutAzureStorageConnectionString").Value,
                    };
                    break;
