            ...
            app.MapWhen(
              ...
              appBranch =>
              {
                  var cloudOptions = new Cloud.CloudOptions
                  {
                      ...
                      Location = CloudLocation.Azure, // using CDN as the cloud provider
                      LogErrors = true,
                      LogPath = Path.Combine(env.WebRootPath, "logs"),

                      CloudUploadConfig = new AzureConfig
                      {
                          DoconutAzureContainerName = Configuration.GetSection("DoconutAzureAccess:DoconutAzureContainerName").Value,
                          DoconutAzureStorageConnectionString = Configuration.GetSection("DoconutAzureAccess:DoconutAzureStorageConnectionString").Value,
                      },
              };
