...
; (function ($) {
    ...
    $.fn.splitter = function (args) {
        ...
        return this.each(function () {
            ...
            A.after(C);
            C.attr({ "class": opts.splitbarClass, unselectable: "on" }).css({ "cursor": opts.cursor, "user-select": "none", "-webkit-user-select": "none", "-khtml-user-select": "none", "-moz-user-select": "none" }).bind("mousedown", startDrag);
            ...
            this.Split = function (perc, reversedorder, fast) {
                splitTo(perc, reversedorder, fast);
            }
            ...
            function splitTo(perc, reversedorder, fast) {
                ...
                var msie = window.navigator.userAgent.toUpperCase().indexOf("MSIE ") > -1;
