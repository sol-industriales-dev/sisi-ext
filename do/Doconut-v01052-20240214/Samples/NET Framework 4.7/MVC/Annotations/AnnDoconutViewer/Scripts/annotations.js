...
function ExportAnnotation() {
    ...
    $.ajax({
        ...
        error: function (textStatus, errorThrown, data) {
            alert("Error exporting to pdf. Error: " + data.responseText);
            loader.hide();
        }
    });
...
function ExportXml() {
    ...
    $.ajax({
        ...
        error: function (textStatus, errorThrown, data) {
            alert("Error exporting to xml. Error: " + data.responseText);
            loader.hide();
        }
    });
