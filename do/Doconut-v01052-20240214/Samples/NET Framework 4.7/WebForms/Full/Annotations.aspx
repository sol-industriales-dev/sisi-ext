<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Annotations.aspx.cs" Inherits="Full.Annotations" %>
...
<body>
    ...
    <a href="javascript:void(0);" onclick="DeleteAnnot();">
        ...
        <asp:Button CssClass="button" ID="btnCodeAnn" Text="Annotation By Code" runat="server" OnClick="btnCodeAnn_Click" />&nbsp;&nbsp;&nbsp;<asp:Button CssClass="button" ID="btnExportPDF" Text="Export Document To PDF"
            runat="server" OnClick="btnExportPDF_Click" />&nbsp;&nbsp;&nbsp;<asp:Button CssClass="button"
                ID="btnExportXML" Text="Export Annotations To XML" runat="server" OnClick="btnExportXML_Click" />&nbsp;&nbsp;
        <div id="div_Debug" style="width: 40%; height: 20px; float: right; border: 1px solid; margin-right: 5px; padding: 2px; background-color: #F5F6CE;">
        </div>
        <br />
        <br />
                    ...
                    <td valign="top">
                        <table style="width: 100%" cellpadding="4" cellspacing="4">
                            <tr id="optBackColor">
                                ...
                                <td>
                                    <div class="controlset">
                                        <input type="text" id="annbackColorFloat" />
                                    </div>
                                </td>
                            </tr>
                            <tr id="optBorderColor">
                                ...
                                <td>
                                    <div class="controlset">
                                        <input type="text" id="annborderColorFloat" />
                                    </div>
                                </td>
                            </tr>
                            <tr id="optRotate">
