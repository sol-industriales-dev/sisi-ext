<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Attachments.aspx.cs" Inherits="Full.Attachments" %>
...
<body>
    ...
    <div id="attachments">
        <div class="file">
            <a title="Resume" class="thickbox" href="Attachments.aspx?File=Sample.doc&TB_iframe=false&height=768&width=1024&KeepThis=true">Sample.doc</a>
        </div>
    </div>
        </div>
        <div id="divDocViewer">
