<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Events.aspx.cs" Inherits="Full.Events" %>
...
<body>
    <form id="form1" runat="server">
        <input type="text" id="debug" style="padding: 5px; margin: 5px; overflow: scroll; height: 25px; width: 98%"
            onclick="this.value = ''" />
        <div id="divDocViewer">
