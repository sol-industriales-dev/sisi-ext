<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print.aspx.cs" Inherits="Full.Print" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Print - Doconut</title>
        ...
        <div id="non-printable">
            <table style="width: 100%">
                <tr>
                    <td>Pages (from : to)</td>
                    <td>
                        <input type="text" id="txtFrom" style="width: 50px" value="1" />&nbsp;:&nbsp;<input type="text" id="txtTo" style="width: 50px" /></td>
                </tr>
                <tr>
                    <td>Zoom Level</td>
                    <td>
                        <input type="text" id="txtZoom" style="width: 50px" value="100" /></td>
                </tr>
                <tr>
                    <td>Paper</td>
                    <td>
                        <select id="drpPaper" style="width: 50px">
                            ...
                            <option value="A4Page" selected="selected">A4</option>
                ...
                <tr>
                    <td>Landscape</td>
                    <td>
                        <input id="chkLandscape" type="checkbox" /></td>
                </tr>
                <tr>
                    <td colspan="2">
                        <input type="button" id="btnPrint" onclick="DoPrint();" value="Print" /></td>
                </tr>
                <tr>
                    <td colspan="2">
