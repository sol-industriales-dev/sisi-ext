<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ribbon.aspx.cs" Inherits="Full.Ribbon" %>
    ...
    <form id="frmRibbon" runat="server">
                        ...
                        <li><a href="javascript:void(0);" accesskey="1" class="orbButton">&nbsp;</a><span>Menu</span>
                            <ul>
                                ...
                                <li><a href="#">
                                    ...
                                    <ul>
                                        <li>
                                            <asp:LinkButton ID="lnkExport" OnClick="lnkExport_Click" runat="server">
                                        <img src="ribbon/images/save_dcn.png" title="DCN Format" /><span>Doconut - DCN Format</span></asp:LinkButton>
                                        </li>
                                        <li>
                                            <asp:LinkButton ID="lnkExportPDF" OnClick="lnkExportPDF_Click" runat="server">
        ...
        <div id="divUpload" style="display: none">
            ...
            <asp:FileUpload ID="uploadFile" runat="server" />&nbsp;<asp:Button ID="btnUploadFile"
                runat="server" Text="Upload File" OnClick="btnUploadFile_Click" />
            <br />
            &nbsp;<b>OR</b>&nbsp;<br />
            <br />
