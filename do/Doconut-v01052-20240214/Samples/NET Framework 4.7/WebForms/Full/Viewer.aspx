<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Viewer.aspx.cs" Inherits="Full.Viewer" %>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarResponsive">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="dropdown">
                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Other Demos
                        <span class="caret"></span>
                            ...
                            <li class="dropdown">
                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Navigation
                        <span class="caret"></span>
                                </a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li>&nbsp;Goto Page:
                                        <select id="cmbPages"></select></li>
                                </ul>
                            </li>
                            <li class="dropdown">
                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Rotate
                        <span class="caret"></span>
                                </a>
                                <ul class="dropdown-menu">
                        ...
                        <span class="caret"></span>
                            ...
                            <li class="dropdown">
                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Zoom
                        <span class="caret"></span>
                                </a>
                                <ul class="dropdown-menu">
                            ...
                            <li class="dropdown">
                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Copy Text
                        <span class="caret"></span>
                                </a>
                                <ul class="dropdown-menu">
                            ...
                            <li class="dropdown">
                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Thumbnails
                        <span class="caret"></span>
                                </a>
                                <ul class="dropdown-menu">
                            ...
                            <li class="dropdown">
                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Functions
                        <span class="caret"></span>
                                </a>
                                <ul class="dropdown-menu">
        ...
        if (typeof jQuery != 'undefined') {
            ...
            $(document).ready(function () {
                ...
                $("#dropZoneForm").dropzone({
                    ...
                    maxFilesize: 20,
                    acceptedFiles: ".doc,.docx,.docm,.odt,.xls,.xlsx,.xlsm,.ods,.csv,.ppt,.pptx,.odp,.vsd,.vsdx,.mpp,.mppx,.pdf,.tif,.tiff,.dwg,.dxf,.dgn,.xps,.psd,.jpg,.jpeg,.jpe,.png,.bmp,.gif,.eml,.msg,.txt,.rtf,.xml,.epub,.svg,.html,.htm,.mht,.dcn,.dcm, .dng, .ico, .eps, .tga, .webp, .cdr, .cmx, .dot, .dotx",
