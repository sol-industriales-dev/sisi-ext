...
public partial class Viewer : System.Web.UI.Page
{
    ...
    protected void ViewUploadedFile(string fileName)
    {
        ...
        // DocFileFormat format = DotnetDaddy.DocumentViewer.DocViewer.GetDocumentFormat(ms); // optional; To know file format
        ...
        */
        ...
        /*
           ctlDoc.OpenDocument(new Uri("your url goes here"));
        */
